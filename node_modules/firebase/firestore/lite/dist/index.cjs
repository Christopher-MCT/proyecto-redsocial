...
function rn(e, n) {
    const r = app._getProvider(e, "firestore/lite");
 ...
 */ function on(t, e, n, r = {}) {
    var s;
    const i = (t = st(t, nn))._getSettings();
 ...
 * terminated.
 */ function un(t) {
    return t = st(t, nn), app._removeServiceInstance(t.app, "firestore/lite"), t._delete();
}
...
function ln(t, e, ...n) {
    if (t = getModularInstance(t), tt("collection", "path", e), t instanceof nn) {
 ...
 * Firestore database.
 */ function mn(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof an && e instanceof an && (t.firestore === e.firestore && le(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function Kn(t, e) {
    return t = getModularInstance(t), e = getModularInstance(e), t instanceof Gn && e instanceof Gn ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof Yn && e instanceof Yn && (mn(t.query, e.query) && pt(t.docs, e.docs, Kn));
}
...
function Er(t, e, n, ...r) {
    ...
    // performing validation.
        let i;
    i = "string" == typeof (e = getModularInstance(e)) || e instanceof pn ? On(s, "updateDoc", t._key, e, n, r) : xn(s, "updateDoc", t._key, e);
 ...
 */ class Dr {
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = getModularInstance(e)) || e instanceof pn ? On(this._dataReader, "WriteBatch.update", s._key, e, n, r) : xn(this._dataReader, "WriteBatch.update", s._key, e), 
...
class Lr {
    ...
    update(t, e, n, ...r) {
        ...
        // performing validation.
                let i;
        return i = "string" == typeof (e = getModularInstance(e)) || e instanceof pn ? On(this._dataReader, "Transaction.update", s._key, e, n, r) : xn(this._dataReader, "Transaction.update", s._key, e), 
 ...
 */ !function(t) {
    ...
    const n = t.getProvider("app").getImmediate(), r = new nn(n, t.getProvider("auth-internal"));
    return e && r._setSettings(e), r;
}), "PUBLIC" /* PUBLIC */)), app.registerVersion("firestore-lite", "3.0.0-2021720181311", "node");

exports.Bytes = _n;
exports.CollectionReference = hn;
exports.DocumentReference = cn;
exports.DocumentSnapshot = Gn;
exports.FieldPath = pn;
exports.FieldValue = gn;
exports.Firestore = nn;
exports.FirestoreError = U;
exports.GeoPoint = vn;
exports.Query = an;
exports.QueryConstraint = Zn;
exports.QueryDocumentSnapshot = Hn;
exports.QuerySnapshot = Yn;
exports.Timestamp = yt;
exports.Transaction = Lr;
exports.WriteBatch = Dr;
exports.addDoc = Ir;
exports.arrayRemove = Vr;
exports.arrayUnion = Rr;
exports.collection = ln;
exports.collectionGroup = fn;
exports.connectFirestoreEmulator = on;
exports.deleteDoc = Tr;
exports.deleteField = Ar;
exports.doc = dn;
exports.documentId = yn;
exports.endAt = fr;
...
exports.initializeFirestore = rn;
exports.limit = ir;
exports.limitToLast = or;
exports.orderBy = rr;
exports.query = Xn;
exports.queryEqual = mn;
exports.refEqual = wn;
exports.runTransaction = Ur;
exports.serverTimestamp = Pr;
exports.setDoc = br;
exports.setLogLevel = w;
exports.snapshotEqual = Kn;
exports.startAfter = ar;
exports.startAt = cr;
exports.terminate = un;
exports.updateDoc = Er;
exports.where = er;
exports.writeBatch = Fr;
