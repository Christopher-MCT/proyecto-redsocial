...
const publicFactory = (container) => {
    ...
    const appConfig = extractAppConfig$1(app$1);
...
function registerMessagingInSw() {
    app._registerComponent(new Component('messaging-sw', SwMessagingFactory, "PUBLIC" /* PUBLIC */));
}
...
function getMessagingInSw(app$1 = app.getApp()) {
    return app._getProvider(getModularInstance(app$1), 'messaging-sw').getImmediate();
}
/**
