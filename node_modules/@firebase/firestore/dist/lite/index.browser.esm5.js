 ...
 */ var m = "9.0.0-2021720181311", y = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var I = "ok", V = "cancelled", P = "unknown", k = "invalid-argument", D = "deadline-exceeded", F = "not-found", N = "permission-denied", O = "unauthenticated", q = "resource-exhausted", L = "failed-precondition", R = "aborted", j = "out-of-range", U = "unimplemented", C = "internal", x = "unavailable", B = /** @class */ function(e) {
    /** @hideconstructor */
    function n(
    /**
...
function(t, e, n, r, i, o, a, s) {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var a = o[i];
            if (a.indexOf("//") >= 0) throw new B(k, "Invalid segment (" + a + "). Paths must not contain // in them.");
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new B(k, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, a = !1; i < t.length; ) {
            var s = t[i];
            if ("\\" === s) {
                if (i + 1 === t.length) throw new B(k, "Path has trailing escape character: " + t);
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new B(k, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
            } else "`" === s ? (a = !a, i++) : "." !== s || a ? (r += s, i++) : (o(), i++);
        }
        if (o(), a) throw new B(k, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
 ...
 */
function nt(t, e, n) {
    if (!n) throw new B(k, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 */ function rt(t) {
    if (!et.isDocumentKey(t)) throw new B(k, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function it(t) {
    if (et.isDocumentKey(t)) throw new B(k, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new B(k, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = ot(t);
        throw new B(k, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function st(t, e) {
    if (e <= 0) throw new B(k, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
...
function dt(t) {
    ...
    // https://github.com/googleapis/googleapis/blob/master/google/rpc/code.proto
      ...
      default:
        return t >= 200 && t < 300 ? I : t >= 400 && t < 500 ? L : t >= 500 && t < 600 ? C : P;
    }
}
 ...
 */ var wt = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new B(k, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new B(k, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new B(k, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new B(k, "Timestamp seconds out of range: " + t);
    }
    /**
...
function Le(t, e) {
    ...
    if (r.get(1) !== t.databaseId.projectId) throw new B(k, "Tried to deserialize key from different project: " + r.get(1) + " vs " + t.databaseId.projectId);
    if (r.get(3) !== t.databaseId.database) throw new B(k, "Tried to deserialize key from different database: " + r.get(3) + " vs " + t.databaseId.database);
            ...
            switch (n.label) {
              case 0:
                return e = A(t), i = function(t, e) {
                    ...
                    return null !== a && (n.structuredQuery.limit = a), e.startAt && (n.structuredQuery.startAt = Ce(e.startAt)), 
 ...
 */ var $e = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new B(k, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new B(k, "cacheSizeBytes must be at least 1048576");
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        this.experimentalForceLongPolling = !!t.experimentalForceLongPolling, this.experimentalAutoDetectLongPolling = !!t.experimentalAutoDetectLongPolling, 
        this.useFetchStreams = !!t.useFetchStreams, function(t, e, n, r) {
            if (!0 === e && !0 === r) throw new B(k, "experimentalForceLongPolling and experimentalAutoDetectLongPolling cannot be used together.");
    ...
    function t(t, e) {
        ...
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new B(k, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new $e(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new B(k, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */ function rn(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        if ("string" == typeof r.mockUserToken) a = r.mockUserToken, s = y.MOCK_USER; else {
            ...
            a = l(r.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
            var u = r.mockUserToken.sub || r.mockUserToken.user_id;
            if (!u) throw new B(k, "mockUserToken must contain 'sub' or 'user_id' field!");
            s = new y(u);
        }
        t._credentials = new z(new G(a, s));
    }
}
 ...
 */ function cn(t, e) {
    ...
    if (!(t instanceof an || t instanceof un)) throw new B(k, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
 ...
 */ function fn(t, e) {
    if (t = at(t, tn), nt("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new B(k, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new sn(t, 
    /* converter= */ null, 
    /**
...
var pn = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new B(k, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ var yn = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new B(k, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new B(k, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new B(k, "Longitude must be a number between -180 and 180, but was: " + e);
...
/** Parse document data from a set() call. */ function In(t, e, n, r, i, o) {
    ...
    Cn("Data must be an object, but it was:", a, r);
    var s, u, c = jn(r, a);
    if (o.merge) s = new St(a.fieldMask), u = a.fieldTransforms; else if (o.mergeFields) {
        for (var f = [], l = 0, h = o.mergeFields; l < h.length; l++) {
            var d = xn(e, h[l], n);
            if (!a.contains(d)) throw new B(k, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            Qn(f, d) || f.push(d);
        }
...
/** Parse update data from a list of field/value arguments. */ function qn(t, e, n, r, i, o) {
    ...
    if (o.length % 2 != 0) throw new B(k, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
 ...
 */ function Rn(t, e) {
    ...
    // from firestore-exp.
    t = h(t))) return Cn("Unsupported field value:", e, t), jn(t, e);
    if (t instanceof vn) 
    ...
    return function(t, e) {
        ...
        if (t instanceof yn) return {
            bytesValue: De(e.L, t._byteString)
        };
        if (t instanceof an) {
...
var Zn = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = An(t.firestore), n = function(t, e, n, r, i, o, a) {
            var s;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new B(k, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            return function(t, e) {
                if (e.S()) {
                    var n = ce(t);
                    if (null !== n && !n.isEqual(e.field)) throw new B(k, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = ue(t);
 ...
 */
                ...
                throw i === e.op ? new B(k, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new B(k, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, h), h;
...
var tr = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new B(k, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new B(k, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new re(e, n);
            return function(t, e) {
                if (null === ue(t)) {
...
/** Helper function to create a bound from a document or fields */ function lr(t, e, n, r) {
    if (n[0] = h(n[0]), n[0] instanceof zn) return function(t, e, n, r, i) {
        ...
        for (var o = [], a = 0, s = le(t); a < s.length; a++) {
            ...
            if (u.field.isKeyField()) o.push(jt(e, r.key)); else {
                ...
                if (kt(c)) throw new B(k, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var f = u.field.canonicalString();
                    throw new B(k, "Invalid query. You are trying to start or end a query using a document for which the field '" + f + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > a.length) throw new B(k, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var s = [], u = 0; u < i.length; u++) {
            var c = i[u];
            if (a[u].field.isKeyField()) {
                if ("string" != typeof c) throw new B(k, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!fe(t) && -1 !== c.indexOf("/")) throw new B(k, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var f = t.path.child(Z.fromString(c));
                if (!et.isDocumentKey(f)) throw new B(k, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + f + "' is not because it contains an odd number of segments.");
                var l = new et(f);
                s.push(jt(e, l));
            } else {
                var h = Ln(n, r, c);
...
function hr(t, e, n) {
    if ("string" == typeof (n = h(n))) {
        if ("" === n) throw new B(k, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!fe(e) && -1 !== n.indexOf("/")) throw new B(k, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(Z.fromString(n));
        if (!et.isDocumentKey(r)) throw new B(k, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return jt(t, new et(r));
    }
    if (n instanceof an) return jt(t, n._key);
    throw new B(k, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ot(n) + ".");
}
 ...
 * array requirements.
 */ function dr(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new B(k, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new B(k, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function pr(t, e, n) {
    if (!n.isEqual(e)) throw new B(k, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var Pr = /** @class */ function() {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = kr(t, this._firestore), i = mr(r.converter, e, n), o = In(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, be.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, a = kr(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
...
function kr(t, e) {
    if ((t = h(t)).firestore !== e) throw new B(k, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ var Fr = /** @class */ function() {
    ...
    return t.prototype.lookup = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new B(k, "Firestore transactions require all reads to be executed before all writes.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new B(k, "Can't update a document that doesn't exist.");
 ...
 */
    ...
    return t.prototype.get = function(t) {
        var e = this, n = kr(t, this._firestore), r = new yr(this._firestore);
        ...
        var r = kr(t, this._firestore), i = mr(r.converter, e, n), o = In(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
