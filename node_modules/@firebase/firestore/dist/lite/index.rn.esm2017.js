 ...
 */ function cn(t, e, n, r = {}) {
    var s;
    const i = (t = it(t, sn))._getSettings();
    ...
    t._setSettings(Object.assign(Object.assign({}, i), {
        ...
        if ("string" == typeof r.mockUserToken) e = r.mockUserToken, n = d.MOCK_USER; else {
            ...
            if (!i) throw new k(P, "mockUserToken must contain 'sub' or 'user_id' field!");
            n = new d(i);
        }
        t._credentials = new Q(new M(e, n));
    }
}
 ...
 */ !function(t) {
    ...
    const n = t.getProvider("app").getImmediate(), r = new sn(n, t.getProvider("auth-internal"));
    return e && r._setSettings(e), r;
}), "PUBLIC" /* PUBLIC */)), s("firestore-lite", "3.0.0-2021720181311", "node");

export { vn as Bytes, fn as CollectionReference, hn as DocumentReference, Yn as DocumentSnapshot, _n as FieldPath, bn as FieldValue, sn as Firestore, k as FirestoreError, En as GeoPoint, ln as Query, tr as QueryConstraint, Kn as QueryDocumentSnapshot, Jn as QuerySnapshot, _t as Timestamp, kr as Transaction, Fr as WriteBatch, Pr as addDoc, Dr as arrayRemove, Nr as arrayUnion, dn as collection, wn as collectionGroup, cn as connectFirestoreEmulator, Ar as deleteDoc, Rr as deleteField, mn as doc, gn as documentId, wr as endAt, dr as endBefore, br as getDoc, Er as getDocs, un as getFirestore, $r as increment, on as initializeFirestore, ur as limit, cr as limitToLast, ir as orderBy, er as query, yn as queryEqual, pn as refEqual, jr as runTransaction, Vr as serverTimestamp, Tr as setDoc, m as setLogLevel, Zn as snapshotEqual, lr as startAfter, hr as startAt, an as terminate, Ir as updateDoc, rr as where, qr as writeBatch };
