...
import { getUA as a, isSafari as c, isMobileCordova as u, isReactNative as h, isElectron as l, isIE as f, isUWP as d, isBrowserExtension as w, createMockUserToken as _, getModularInstance as m, deepEqual as g } from "@firebase/util";
 ...
 */ class Ms {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Ms._t(a()) && F("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static gt() {
        ...
        // Check the UA string to find out the browser.
                const t = a(), e = Ms._t(t), n = 0 < e && e < 10, s = Ms.Et(t), i = 0 < s && s < 4.5;
        // IE 10
 ...
 */
     ...
     */    Ge() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ke = () => {
            ...
            this.cn(), c() && navigator.appVersion.match("Version/14") && 
 ...
 */ class Zi {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Cn(e, i);
            return (oe(e) || ae(e)) && this.Nn(e.limitType, r, s, n) ? this.Dn(t, e) : (k() <= p.DEBUG && O("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), me(e)), 
    ...
    Dn(t, e) {
        return k() <= p.DEBUG && O("QueryEngine", "Using full collection scan to execute query:", me(e)), 
...
class {
    ...
    Fi(t, e) {
        ...
        u() || h() || l() || f() || d() || w() || (r.httpHeadersOverwriteParam = "$httpHeaders");
        const o = n.join("");
...
function Rc(t, e, ...n) {
    if (t = m(t), lc("collection", "path", e), t instanceof pc) {
 ...
 * Firestore database.
 */ function vc(t, e) {
    return t = m(t), e = m(e), (t instanceof Tc || t instanceof Ac) && (e instanceof Tc || e instanceof Ac) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Vc(t, e) {
    return t = m(t), e = m(e), t instanceof Ic && e instanceof Ic && (t.firestore === e.firestore && we(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ function gu(t, e) {
    ...
    // from firestore-exp.
    t = m(t))) return Eu("Unsupported field value:", e, t), yu(t, e);
    if (t instanceof Xc) 
 ...
 */ function Tu(t, e, n) {
    ...
    // FieldPath.
    e = m(e)) instanceof Hc) return e._internalPath;
...
/** Helper function to create a bound from a document or fields */ function Yu(t, e, n, s) {
    if (n[0] = m(n[0]), n[0] instanceof bu) return function(t, e, n, s, i) {
 ...
 */ class ih {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = m(e)) || e instanceof Hc ? _u(this._dataReader, "WriteBatch.update", i._key, e, n, s) : wu(this._dataReader, "WriteBatch.update", i._key, e), 
...
function rh(t, e) {
    if ((t = m(t)).firestore !== e) throw new N(C.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function wh(t, e, n, ...s) {
    ...
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = m(e)) || e instanceof Hc ? _u(r, "updateDoc", t._key, e, n, s) : wu(r, "updateDoc", t._key, e);
 ...
 */ class Th extends class {
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = m(e)) || e instanceof Hc ? _u(this._dataReader, "Transaction.update", i._key, e, n, s) : wu(this._dataReader, "Transaction.update", i._key, e), 
...
}), "PUBLIC" /* PUBLIC */)), i("@firebase/firestore", "3.0.0-2021720181311", Sh);
