...
import { getUA as f, isSafari as l, isMobileCordova as d, isReactNative as p, isElectron as y, isIE as v, isUWP as m, isBrowserExtension as g, createMockUserToken as w, getModularInstance as b, deepEqual as I } from "@firebase/util";

import { Logger as T, LogLevel as E } from "@firebase/logger";

import { XhrIo as S, EventType as _, ErrorCode as N, createWebChannelTransport as D, getStatEventTarget as A, FetchXmlHttpFactory as k, WebChannel as C, Event as R, Stat as x } from "@firebase/webchannel-wrapper";
 ...
 */ var O = "9.0.0-2021720181311", L = /** @class */ function() {
    function t(t, e) {
        var n = this;
...
var P = {
    ...
    return t(n, e), n;
}(Error), F = new T("@firebase/firestore");
...
function U(t) {
    ...
    if (F.logLevel <= E.DEBUG) {
        var i = n.map(K);
        F.debug.apply(F, e([ "Firestore (" + O + "): " + t ], i));
    }
}

function B(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (F.logLevel <= E.ERROR) {
        var i = n.map(K);
        F.error.apply(F, e([ "Firestore (" + O + "): " + t ], i));
    }
}
 ...
 */ function j(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (F.logLevel <= E.WARN) {
        var i = n.map(K);
        F.warn.apply(F, e([ "Firestore (" + O + "): " + t ], i));
    }
}
 ...
 */ var Y = /** @class */ function() {
    ...
    return t.u = function() {
        ...
        ; n.length < 20; ) for (var r = H(40), i = 0; i < r.length; ++i) 
 ...
 */ var Z = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new M(P.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new M(P.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new M(P.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new M(P.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var it = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new M(P.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
...
}(it), st = /^[_a-zA-Z][_a-zA-Z0-9]*$/, at = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new M(P.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var a = t[i];
            if ("\\" === a) {
                if (i + 1 === t.length) throw new M(P.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var u = t[i + 1];
                if ("\\" !== u && "." !== u && "`" !== u) throw new M(P.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += u, i += 2;
            } else "`" === a ? (s = !s, i++) : "." !== a || s ? (r += a, i++) : (o(), i++);
        }
        if (o(), s) throw new M(P.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
}(it), ut = /** @class */ function() {
    function t(t) {
        this.fields = t, 
 ...
 */ var It = /** @class */ function() {
    ...
    return t.fromPath = function(e) {
        return new t(ot.fromString(e));
    }, t.fromName = function(e) {
        return new t(ot.fromString(e).popFirst(5));
    }, 
...
/** Extracts the backend's type order for the provided value. */ function Tt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? yt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : G();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Et(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return $(t.arrayValue.values || [], e.arrayValue.values || [], Et);
...
function _t(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = X(dt(t.latitude), dt(e.latitude));
            return 0 !== n ? n : X(dt(t.longitude), dt(e.longitude));
...
function Nt(t, e) {
    ...
    var n = lt(t), r = lt(e), i = X(n.seconds, r.seconds);
...
/** Creates a deep copy of `source`. */ function Pt(t) {
    ...
    if (t.mapValue) {
        ...
        return nt(t.mapValue.fields, (function(t, n) {
            return e.mapValue.fields[t] = Pt(n);
        })), e;
    }
    if (t.arrayValue) {
        for (var n = {
        ...
        }, r = 0; r < (t.arrayValue.values || []).length; ++r) n.arrayValue.values[r] = Pt(t.arrayValue.values[r]);
        return n;
    }
 ...
 */ var Mt = /** @class */ function() {
    ...
    t.prototype.field = function(t) {
        ...
        for (var e = this.value, n = 0; n < t.length - 1; ++n) if (!Lt(e = (e.mapValue.fields || {})[t.get(n)])) return null;
    ...
    t.prototype.setAll = function(t) {
        ...
        t.forEach((function(t, o) {
            ...
            t ? r[o.lastSegment()] = Pt(t) : i.push(o.lastSegment());
        }));
...
var Vt = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , tt.min(), Mt.empty(), 0 /* SYNCED */);
    }, 
    /**
...
function Bt(t) {
    ...
    if (null === e.h) {
        ...
        n += te(e.startAt)), e.endAt && (n += "|ub:", n += te(e.endAt)), e.h = n;
    }
    return e.h;
}
...
function jt(t, e) {
    ...
    i.op !== o.op || !i.field.isEqual(o.field) || !Et(i.value, o.value)) return !1;
    var i, o;
...
var Gt = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.l(t, e, r) : new zt(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Yt(t, r) : "in" /* IN */ === e ? new Xt(t, r) : "not-in" /* NOT_IN */ === e ? new $t(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Jt(t, r) : new n(t, e, r);
    }, n.l = function(t, e, n) {
        return "in" /* IN */ === e ? new Qt(t, n) : new Wt(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.m(_t(e, this.value)) : null !== e && Tt(this.value) === Tt(e) && this.m(_t(e, this.value));
...
}(Gt), Qt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = Ht("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
...
}(Gt), Wt = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = Ht("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** Filter that matches on key fields within an array. */ function Ht(t, e) {
    var n;
...
/** A Filter that implements the array-contains operator. */ var Yt = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return Rt(e) && St(e.arrayValue, this.value);
    }, n;
}(Gt), Xt = /** @class */ function(e) {
    function n(t, n) {
 ...
 */ function re(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? It.comparator(It.fromName(s.referenceValue), n.key) : _t(s, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function se(t, e, n, r, i, o, s, a) {
    return new oe(t, e, n, r, i, o, s, a);
}
 ...
 */ function de(t) {
    ...
    if (null === e.p) {
        ...
        n.isKeyField() || e.p.push(new ee(n)), e.p.push(new ee(at.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function pe(t) {
    var e = W(t);
    if (!e.T) if ("F" /* First */ === e.limitType) e.T = Ut(e.path, e.collectionGroup, de(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = de(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new ee(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var a = e.endAt ? new Zt(e.endAt.position, !e.endAt.before) : null, u = e.startAt ? new Zt(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.T = Ut(e.path, e.collectionGroup, n, e.filters, e.limit, a, u);
    }
    return e.T;
}
...
function ve(t, e) {
    return jt(pe(t), pe(e)) && t.limitType === e.limitType;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function we(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !re(t.startAt, de(t), e)) && (!t.endAt || !re(t.endAt, de(t), e));
    }(t, e);
}

function be(t) {
    return function(e, n) {
        for (var r = !1, i = 0, o = de(t); i < o.length; i++) {
            var s = o[i], a = Ie(s, e, n);
            if (0 !== a) return a;
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var _e = function() {
 ...
 */ function Ne(t, e, n) {
    ...
    }(n, e) : t instanceof Ce ? Re(t, e) : t instanceof xe ? Oe(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = Ae(t, e), r = Pe(n) + Pe(t.A);
        return Ct(n) && Ct(t.A) ? Ee(r) : Te(t.R, r);
    }(t, e);
}
 ...
 */ function De(t, e, n) {
    ...
    // applications.
    return t instanceof Ce ? Re(t, e) : t instanceof xe ? Oe(t, e) : n;
}
 ...
 */ function Ae(t, e) {
    return t instanceof Le ? Ct(n = e) || function(t) {
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Fe = function(t, e) {
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function Ue(t, e) {
 ...
 */ function je(t, e, n) {
    t instanceof We ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Xe(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof He ? function(t, e, n) {
        if (Ue(t.precondition, e)) {
            var r = Xe(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(Ye(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Ke(t, e, n) {
    t instanceof We ? function(t, e, n) {
        if (Ue(t.precondition, e)) {
            var r = t.value.clone(), i = $e(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(Qe(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof He ? function(t, e, n) {
        if (Ue(t.precondition, e)) {
            var r = $e(t.fieldTransforms, n, e), i = e.data;
            i.setAll(Ye(t)), i.setAll(r), e.convertToFoundDocument(Qe(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Ue(t.precondition, e) && 
        // We don't call `setHasLocalMutations()` since we want to be backwards
        // compatible with the existing SDK behavior.
        e.convertToNoDocument(tt.min());
    }(t, e);
}
 ...
 */ function Ge(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), a = Ae(o.transform, s || null);
        null != a && (null == n && (n = Mt.empty()), n.set(o.field, a));
    }
    return n || null;
}
...
function ze(t, e) {
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.precondition.isEqual(e.precondition) && !!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && $(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Ce && e instanceof Ce || t instanceof xe && e instanceof xe ? $(t.elements, e.elements, Et) : t instanceof Le && e instanceof Le ? Et(t.A, e.A) : t instanceof ke && e instanceof ke;
 ...
 */ function Qe(t) {
    return t.isFoundDocument() ? t.version : tt.min();
}
 ...
 */ function $e(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, Ne(a, u, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var Je, Ze, tn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ function on(t) {
    ...
    return B("GRPC error has no .code"), P.UNKNOWN;
    switch (t) {
      case Je.OK:
        return P.OK;
 ...
 *     Code.UNKNOWN.
 */ (Ze = Je || (Je = {}))[Ze.OK = 0] = "OK", Ze[Ze.CANCELLED = 1] = "CANCELLED", 
...
var sn = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, un.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, un.BLACK, null, null));
    }, 
    ...
    t.prototype.getIterator = function() {
        ...
        return new an(this.root, t, this.comparator, !1);
        ...
        return new an(this.root, t, this.comparator, !0);
    }, t;
}(), an = /** @class */ function() {
    function t(t, e, n, r) {
...
var cn = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.firstAfterOrEqual = function(t) {
        ...
        return new hn(this.data.getIterator());
    }, t.prototype.getIteratorFrom = function(t) {
        return new hn(this.data.getIteratorFrom(t));
    }, 
...
}(), fn = new sn(It.comparator);

function ln() {
    return fn;
}

var dn = new sn(It.comparator);

function pn() {
    return dn;
}

var yn = new sn(It.comparator);

function vn() {
    return yn;
}

var mn = new cn(It.comparator);
 ...
 */ var In = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Tn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(tt.min(), r, bn(), ln(), gn());
    }, t;
}(), Tn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(ht.EMPTY_BYTE_STRING, n, gn(), gn(), gn());
    }, t;
}(), En = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = ht.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    function t() {
        ...
        this.C = ht.EMPTY_BYTE_STRING, this.N = !1, 
        /**
    ...
    t.prototype.rt = function(t) {
        ...
        if (r) {
            ...
            if (Kt(i)) if (0 === n) {
                ...
                // queries.
                var o = new It(i.path);
                this.tt(e, o, Vt.newNoDocument(o, tt.min()));
            } else z(1 === n); else this.at(e) !== n && (
    ...
    t.prototype.ct = function(t) {
        ...
        this.G.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Kt(o.target)) {
                    ...
                    null !== e.H.get(s) || e.ut(i, s) || e.tt(i, s, Vt.newNoDocument(s, t));
                }
                r.O && (n.set(i, r.M()), r.L());
            }
        }));
        ...
        var i = new In(t, n, this.Y, this.H, r);
        return this.H = ln(), this.J = An(), this.Y = new cn(X), i;
    }, 
    /**
    ...
    t.prototype.q = function(t) {
        ...
        var e = this.G.get(t);
        return e || (e = new Nn, this.G.set(t, e)), e;
    }, t.prototype.ht = function(t) {
        var e = this.J.get(t);
        return e || (e = new cn(X), this.J = this.J.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.it = function(t) {
        var e = this;
        this.G.set(t, new Nn), this.W.getRemoteKeysForTarget(t).forEach((function(n) {
 ...
 */ function Pn(t, e) {
    return On(t, e.toTimestamp());
}

function Mn(t) {
    return z(!!t), tt.fromTimestamp(function(t) {
        var e = lt(t);
        return new Z(e.seconds, e.nanos);
    }(t));
}
...
function Vn(t) {
    var e = ot.fromString(t);
    return z(ur(e)), e;
}

function qn(t, e) {
    return Fn(t.databaseId, e.path);
}

function Un(t, e) {
    var n = Vn(e);
    if (n.get(1) !== t.databaseId.projectId) throw new M(P.INVALID_ARGUMENT, "Tried to deserialize key from different project: " + n.get(1) + " vs " + t.databaseId.projectId);
    if (n.get(3) !== t.databaseId.database) throw new M(P.INVALID_ARGUMENT, "Tried to deserialize key from different database: " + n.get(3) + " vs " + t.databaseId.database);
    return new It(Gn(n));
}

function Bn(t, e) {
    return Fn(t.databaseId, e);
}
...
function jn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? ot.emptyPath() : Gn(e);
}
...
function Qn(t, e, n) {
    var r = Un(t, e.name), i = Mn(e.updateTime), o = new Mt({
        mapValue: {
            fields: e.fields
        }
    }), s = Vt.newFoundDocument(r, i, o);
...
function Hn(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? qe.updateTime(Mn(t.updateTime)) : void 0 !== t.exists ? qe.exists(t.exists) : qe.none();
    }(e.currentDocument) : qe.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new ke; else if ("appendMissingElements" in e) {
                var r = e.appendMissingElements.values || [];
                n = new Ce(r);
            } else if ("removeAllFromArray" in e) {
                var i = e.removeAllFromArray.values || [];
                n = new xe(i);
            } else "increment" in e ? n = new Le(t, e.increment) : G();
            var o = at.fromServerFormat(e.fieldPath);
            return new Fe(o, n);
        }(t, e);
    })) : [];
    if (e.update) {
        e.update.name;
        var i = Un(t, e.update.name), o = new Mt({
            mapValue: {
        ...
        if (e.updateMask) {
            var s = function(t) {
                var e = t.fieldPaths || [];
                return new ut(e.map((function(t) {
                    return at.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new He(i, o, s, n, r);
        }
...
function Xn(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Bn(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Bn(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Zn(e.startAt)), 
...
function $n(t) {
    ...
    var s = [];
    n.where && (s = Jn(n.where));
    var a = [];
    n.orderBy && (a = n.orderBy.map((function(t) {
        return function(t) {
            return new ee(ir(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var c = null;
    n.startAt && (c = tr(n.startAt));
    var h = null;
    return n.endAt && (h = tr(n.endAt)), se(e, i, a, s, u, "F" /* First */ , c, h);
}

function Jn(t) {
    return t ? void 0 !== t.unaryFilter ? [ sr(t) ] : void 0 !== t.fieldFilter ? [ or(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Jn(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : G() : [];
...
function or(t) {
    return Gt.create(ir(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function sr(t) {
    switch (t.unaryFilter.op) {
      ...
      case "IS_NULL":
        ...
        return Gt.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = ir(t.unaryFilter.field);
        return Gt.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = ir(t.unaryFilter.field);
        return Gt.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
 ...
 */ function cr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = fr(e)), e = hr(t.get(n), e);
    return fr(e);
}

/** Encodes a single segment of a resource path into the given result */ function hr(t, e) {
...
/** Encodes a path separator into the given result */ function fr(t) {
    return t + "";
}
 ...
 */ function lr(t) {
    ...
    var e = t.length;
    if (z(e >= 2), 2 === e) return z("" === t.charAt(0) && "" === t.charAt(1)), ot.emptyPath();
...
/**
     ...
     */
br.readTimeIndex = "readTimeIndex", br.readTimeIndexPath = "readTime", 
/**
     ...
     */
br.collectionReadTimeIndex = "collectionReadTimeIndex", br.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
Ir.store = "remoteDocumentGlobal", Ir.key = "remoteDocumentGlobalKey";
...
Tr.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
Tr.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store.  */ Er.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Er.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Er.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Er.documentTargetsKeyPath = [ "path", "targetId" ];
 ...
 */ Sr.key = "targetGlobalKey", Sr.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ _r.store = "collectionParents", 
...
/** Name of the IndexedDb object store. */ Nr.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Dr.store = "bundles", Dr.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ Ar.store = "namedQueries", Ar.keyPath = "name";

// Visible for testing
var kr = e(e([], e(e([], e(e([], e(e([], [ yr.store, vr.store, mr.store, br.store, Tr.store, pr.store, Sr.store, Er.store ]), [ Nr.store ])), [ Ir.store ])), [ _r.store ])), [ Dr.store, Ar.store ]), Cr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Rr = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.ft = new xr, this.transaction.oncomplete = function() {
            n.ft.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.ft.reject(new Fr(t, e.error)) : n.ft.resolve();
        }, this.transaction.onerror = function(e) {
            var r = jr(e.target.error);
            n.ft.reject(new Fr(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
        ...
        t && this.ft.reject(t), this.aborted || (U("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t._t(f()) && B("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), Ur(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, r) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            r(new Fr(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, i.onerror = function(e) {
                            var n = e.target.error;
                            "VersionError" === n.name ? r(new M(P.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : r(new Fr(t, n));
                    ...
                    n = "readonly" === e, s = 0, a = function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 4, , 5 ]), [ 4 /*yield*/ , u.At(t) ];

                              case 2:
                                // Wait for the transaction to complete (i.e. IndexedDb's onsuccess event to
                                // fire), but still return the original transactionFnResult back to the
                                // caller.
                                return u.db = r.sent(), e = Lr.open(u.db, t, n ? "readonly" : "readwrite", i), a = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), Or.reject(t);
                                })).toPromise(), c = {}, a.catch((function() {})), [ 4 /*yield*/ , e.dt ];
 ...
 */ var qr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), Ur(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return U("SimpleDb", "DELETE", this.store.name, t), Ur(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), Ur(this.store.count());
...
function jr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(n) >= 0) {
            ...
            var r = new M("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + n + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Br || (Br = !0, 
 ...
 */ var zr = /** @class */ function() {
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && Ke(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && Ke(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t) {
        ...
        // to O(n).
            ...
            // and we should remove this cast.
                        e.applyToLocalView(i), r.isValidDocument() || i.convertToNoDocument(tt.min());
        }));
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = vn(), o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = tt.min()), void 0 === o && (o = tt.min()), void 0 === s && (s = ht.EMPTY_BYTE_STRING), 
...
/** Decodes a remote document from storage locally to a Document. */ function Yr(t, e) {
    if (e.document) return Qn(t.Lt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        var n = It.fromSegments(e.noDocument.path), r = ti(e.noDocument.readTime), i = Vt.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = It.fromSegments(e.unknownDocument.path), s = ti(e.unknownDocument.version);
        return Vt.newUnknownDocument(o, s);
    }
    return G();
}

/** Encodes a document for storage locally. */ function Xr(t, e, n) {
    var r = $r(n), i = e.key.path.popLast().toArray();
    if (e.isFoundDocument()) {
        var o = function(t, e) {
            return {
                name: qn(t, e.key),
                fields: e.data.value.mapValue.fields,
                updateTime: On(t, e.version.toTimestamp())
            };
    ...
    if (e.isNoDocument()) {
        var a = e.key.path.toArray(), u = Zr(e.version), c = e.hasCommittedMutations;
        return new br(
        /* unknownDocument= */ null, new gr(a, u), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = Zr(e.version);
        return new br(new wr(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function ei(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return Hn(t.Lt, e);
    })), a = Z.fromMillis(e.localWriteTimeMs);
    return new zr(e.batchId, a, n, s);
}

/** Decodes a DbTarget into TargetData */ function ni(t) {
    var e, n, r = ti(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? ti(t.lastLimboFreeSnapshotVersion) : tt.min();
    return void 0 !== t.query.documents ? (z(1 === (n = t.query).documents.length), 
    e = pe(ae(jn(n.documents[0])))) : e = function(t) {
        return pe($n(t));
    }(t.query), new Wr(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, ht.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function ri(t, e) {
    var n, r = Zr(e.snapshotVersion), i = Zr(e.lastLimboFreeSnapshotVersion);
    n = Kt(e.target) ? Yn(t.Lt, e.target) : Xn(t.Lt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Tr(e.targetId, Bt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ var ui = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Bt.add(e), Or.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return Or.resolve(this.Bt.getEntries(e));
    }, t;
}(), ci = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new cn(ot.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new cn(ot.comparator)).toArray();
    }, t;
}(), hi = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return fi(t).Nt(r).next((function(t) {
 ...
 */
function pi(t, e, n) {
    var r = t.store(vr.store), i = t.store(mr.store), o = [], s = IDBKeyRange.only(n.batchId), a = 0, u = r.Ot({
        range: s
    }, (function(t, e, n) {
        return a++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = mr.key(e, l.key.path, n.batchId);
        o.push(i.delete(d)), c.push(l.key);
    }
    return Or.waitFor(o).next((function() {
        return c;
    }));
}
...
var vi = /** @class */ function() {
    ...
    return t.jt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(a) {
            z("number" == typeof a);
            for (var u = new zr(a, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return Wn(t.Lt, e);
                })), i = n.mutations.map((function(e) {
                    return Wn(t.Lt, e);
                }));
                return new vr(e, n.batchId, n.localWriteTime.toMillis(), r, i);
            }(i.R, i.userId, u), h = [], f = new cn((function(t, e) {
                return X(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = mr.key(i.userId, p.key.path, a);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, mr.PLACEHOLDER));
            }
            return f.forEach((function(e) {
                h.push(i.qt.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Kt[a] = u.keys();
            })), Or.waitFor(h).next((function() {
                return u;
            }));
        }));
        ...
        return gi(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), ei(n.R, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Qt = function(t, e) {
        var n = this;
        return this.Kt[e] ? Or.resolve(this.Kt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Kt[e] = r, r;
            }
        ...
        return gi(t).Ot({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = ei(n.R, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return gi(t).Nt(vr.userMutationsIndex, n).next((function(t) {
        ...
        // the given documentKey.
            ...
            return gi(t).get(c).next((function(t) {
                if (!t) throw G();
                z(t.userId === n.userId), o.push(ei(n.R, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new cn(X), i = [];
        return e.forEach((function(e) {
            var o = mr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), a = wi(t).Ot({
                range: s
            }, (function(t, i, o) {
                var s = t[0], a = t[1], u = t[2], c = lr(a);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(a);
        })), Or.waitFor(i).next((function() {
            return n.Wt(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = mr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), a = new cn(X);
        return wi(t).Ot({
            range: s
        }, (function(t, e, o) {
            var s = t[0], u = t[1], c = t[2], h = lr(u);
        ...
        return e.forEach((function(e) {
            i.push(gi(t).get(e).next((function(t) {
                if (null === t) throw G();
                z(t.userId === n.userId), r.push(ei(n.R, t));
            })));
        })), Or.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return pi(t.Mt, this.userId, e).next((function(r) {
 ...
 */ function mi(t, e, n) {
    var r = mr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return wi(t).Ot({
        range: o,
        $t: !0
    }, (function(t, n, r) {
 ...
 */ var Ii = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.Xt(t).next((function(t) {
            return tt.fromTimestamp(new Z(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            return Ei(t).delete(e.targetId);
        })).next((function() {
            return n.Xt(t);
        })).next((function(e) {
            return z(e.targetCount > 0), e.targetCount -= 1, n.Zt(t, e);
        }));
    }, 
    /**
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return Ei(t).Ot((function(t, n) {
            var r = ni(n);
            e(r);
        }));
    }, t.prototype.Xt = function(t) {
        return Si(t).get(Sr.key).next((function(t) {
            return z(null !== t), t;
        }));
    }, t.prototype.Zt = function(t, e) {
        return Si(t).put(Sr.key, e);
    }, t.prototype.te = function(t, e) {
        return Ei(t).put(ri(this.R, e));
    }, 
    /**
    ...
    t.prototype.ee = function(t, e) {
        ...
        var n = Bt(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return Ei(t).Ot({
            range: r,
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = cr(e.path);
            i.push(o.put(new Er(n, s))), i.push(r.referenceDelegate.addReference(t, n, e));
        })), Or.waitFor(i);
        ...
        // IndexedDb.
            ...
            var o = cr(e.path);
            return Or.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = _i(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        var n = cr(e.path), r = IDBKeyRange.bound([ n ], [ J(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return _i(t).Ot({
            index: Er.documentTargetsIndex,
            $t: !0,
            range: r
        }, (function(t, e, n) {
            var r = t[0];
 ...
 */ function Ni(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== P.FAILED_PRECONDITION || t.message !== Cr) throw t;
 ...
 */ var Ai = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        ...
        U("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.ae = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        this.ae = null, this.oe = !0, n.label = 1;
                      ...
                      case 3:
                        return Vr(e = n.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        Or.resolve(li)) : this.getCacheSize(t).next((function(r) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return u = Date.now(), V() <= E.DEBUG && U("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (a - s) + "ms\n\tRemoved " + t + " documents in " + (u - a) + "ms\nTotal Duration: " + (u - h) + "ms"), 
            Or.resolve({
                didRun: !0,
            ...
            if (a <= e) {
                var u = n._e(t, s).next((function(e) {
                    ...
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), _i(t).delete([ 0, cr(s.path) ]);
                    }));
                }));
                i.push(u);
            }
 ...
 */ var Oi = /** @class */ function() {
    ...
    function t() {
        ...
        this.changes = new Oi((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? Or.resolve(n.document) : this.getFromCache(t, e);
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Vi(t).get(qi(e)).next((function(t) {
            return n.ge(e, t);
        }));
    }, 
    /**
     ...
     */
    t.prototype.Ee = function(t, e) {
        var n = this, r = ln(), i = new sn(It.comparator);
        return this.pe(t, e, (function(t, e) {
            var o = n.ge(t, e);
            r = r.insert(t, o), i = i.insert(t, yi(e));
        })).next((function() {
            return {
                documents: r,
                Te: i
        ...
        if (e.isEmpty()) return Or.resolve();
        var r = IDBKeyRange.bound(e.first().path.toArray(), e.last().path.toArray()), i = e.getIterator(), o = i.getNext();
        return Vi(t).Ot({
            range: r
        }, (function(t, e, r) {
            // Go through keys not found in cache.
            for (var s = It.fromSegments(t); o && It.comparator(o, s) < 0; ) n(o, null), o = i.getNext();
            o && o.isEqual(s) && (
            // Key found in cache.
        ...
        var r = this, i = ln(), o = e.path.length + 1, s = {};
        if (n.isEqual(tt.min())) {
            ...
            var u = e.path.toArray(), c = $r(n);
            s.range = IDBKeyRange.lowerBound([ u, c ], 
            /* open= */ !0), s.index = br.collectionReadTimeIndex;
        }
        return Vi(t).Ot(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var a = Yr(r.R, n);
                e.path.isPrefixOf(a.key.path) ? we(e, a) && (i = i.insert(a.key, a)) : s.done();
            }
        })).next((function() {
            return i;
        }));
        ...
        return Fi(t).get(Ir.key).next((function(t) {
            return z(!!t), t;
        }));
    }, t.prototype.me = function(t, e) {
        return Fi(t).put(Ir.key, e);
    }, 
    /**
    ...
    t.prototype.ge = function(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!n.isNoDocument() || !n.version.isEqual(tt.min())) return n;
        }
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new cn((function(t, e) {
            return X(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, s) {
            var a = e.Ae.get(o);
            if (s.document.isValidDocument()) {
                var u = Xr(e.Ie.R, s.document, e.getReadTime(o));
 ...
 */ function Fi(t) {
    return Gr(t, Ir.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Vi(t) {
    return Gr(t, br.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Ui = /** @class */ function() {
    function t(t) {
        this.R = t;
    }
    /**
     ...
     */    return t.prototype.Rt = function(t, e, n, r) {
        var i = this;
        z(n < r && n >= 0 && r <= 11);
        var o = new Lr("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Er.store), t.deleteObjectStore(Tr.store), t.deleteObjectStore(Sr.store);
        }(t), Bi(t)), s = s.next((function() {
            /**
     ...
     */
            return function(t) {
                var e = t.store(Sr.store), n = new Sr(
                /*highestTargetId=*/ 0, 
                /*lastListenSequenceNumber=*/ 0, tt.min().toTimestamp(), 
                /*targetCount=*/ 0);
                return e.put(Sr.key, n);
            }(o);
        }))), n < 4 && r >= 4 && (0 !== n && (
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(vr.store).Nt().next((function(n) {
            ...
            !function(t) {
                ...
                var e = t.objectStore(br.store);
                e.createIndex(br.readTimeIndex, br.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(br.collectionReadTimeIndex, br.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(br.store).Ot((function(t, n) {
            e += yi(n);
        })).next((function() {
            var n = new Ir(e);
            return t.store(Ir.store).put(Ir.key, n);
        }));
    }, t.prototype.Re = function(t) {
        var e = this, n = t.store(yr.store), r = t.store(vr.store);
        return n.Nt().next((function(n) {
            return Or.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Nt(vr.userMutationsIndex, i).next((function(r) {
    ...
    t.prototype.be = function(t) {
        var e = t.store(Er.store), n = t.store(br.store);
        return t.store(Sr.store).get(Sr.key).next((function(t) {
            var r = [];
            return n.Ot((function(n, i) {
                var o = new ot(n), s = function(t) {
                    return [ 0, cr(t) ];
                }(o);
                r.push(e.get(s).next((function(n) {
                    return n ? Or.resolve() : function(n) {
                        return e.put(new Er(0, cr(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return Or.waitFor(r);
        ...
        var n = e.store(_r.store), r = new ci, i = function(t) {
            if (r.add(t)) {
        ...
        var e = this, n = t.store(Tr.store);
        return n.Ot((function(t, r) {
            var i = ni(r), o = ri(e.R, i);
            return n.put(o);
        }));
    }, t;
}();
...
function Bi(t) {
    t.createObjectStore(Er.store, {
        keyPath: Er.keyPath
    }).createIndex(Er.documentTargetsIndex, Er.documentTargetsKeyPath, {
        unique: !0
    }), 
...
var ji = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Ki = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        this.Se = o, this.window = s, this.document = a, this.De = c, this.Ce = h, this.Ne = null, 
        ...
        }, !t.gt()) throw new M(P.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Ri(this, i), this.Le = n + "main", this.R = new Hr(u), 
        this.Be = new Pr(this.Le, 11, new Ui(this.R)), this.Ue = new Ti(this.referenceDelegate, this.R), 
        this.qt = new hi, this.qe = function(t, e) {
            return new Pi(t, e);
        }(this.R, this.qt), this.Ke = new oi, this.window && this.window.localStorage ? this.je = this.window.localStorage : (this.je = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new M(P.FAILED_PRECONDITION, ji);
    ...
    t.prototype.Qe = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return zi(e).put(new Nr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
        ...
        var e = this;
        return Gi(t).get(pr.key).next((function(t) {
            return Or.resolve(e.tn(t));
        }));
    ...
    t.prototype.Ye = function(t) {
        var e = this;
        return this.Ce ? Or.resolve(!0) : Gi(t).get(pr.key).next((function(n) {
            ...
            if (null !== n && e.sn(n.leaseTimestampMs, 5e3) && !e.an(n.ownerId)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || zi(t).Nt().next((function(t) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.xe = !1, this.cn(), this.Oe && (this.Oe.cancel(), this.Oe = null), this.un(), 
                    this.hn(), [ 4 /*yield*/ , this.Be.runTransaction("shutdown", "readwrite", [ pr.store, Nr.store ], (function(e) {
                        var n = new Kr(e, L.o);
    ...
    t.prototype.rn = function(t, e) {
        ...
        return t.filter((function(t) {
            return n.sn(t.updateTimeMs, e) && !n.an(t.clientId);
        }));
    }, 
    /**
    ...
    t.prototype.fn = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return zi(e).Nt().next((function(e) {
        ...
        return vi.jt(t, this.R, this.qt, this.referenceDelegate);
        ...
        return this.Be.runTransaction(t, o, kr, (function(o) {
            return i = new Kr(o, r.Ne ? r.Ne.next() : L.o), "readwrite-primary" === e ? r.Je(i).next((function(t) {
                return !!t || r.Ye(i);
            })).next((function(e) {
                if (!e) throw B("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Se.enqueueRetryable((function() {
                    return r.Me(!1);
                })), new M(P.FAILED_PRECONDITION, Cr);
                return n(i);
            })).next((function(t) {
    ...
    t.prototype.dn = function(t) {
        var e = this;
        return Gi(t).get(pr.key).next((function(t) {
            if (null !== t && e.sn(t.leaseTimestampMs, 5e3) && !e.an(t.ownerId) && !e.tn(t) && !(e.Ce || e.allowTabSynchronization && t.allowTabSynchronization)) throw new M(P.FAILED_PRECONDITION, ji);
        }));
    }, 
    /**
    ...
    t.prototype.Ze = function(t) {
        var e = new pr(this.clientId, this.allowTabSynchronization, Date.now());
        return Gi(t).put(pr.key, e);
    }, t.gt = function() {
        return Pr.gt();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xe = function(t) {
        var e = this, n = Gi(t);
        return n.get(pr.key).next((function(t) {
            return e.tn(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete(pr.key)) : Or.resolve();
        }));
    }, 
    ...
    t.prototype.Ge = function() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.ke = function() {
            ...
            e.cn(), l() && navigator.appVersion.match("Version/14") && 
 ...
 */
        return function(t) {
            return It.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Tn(t, e.path) : le(e) ? this.In(t, e, n) : this.An(t, e, n);
        ...
        return this.qt.getCollectionParents(t, i).next((function(s) {
            return Or.forEach(s, (function(s) {
                var a = function(t, e) {
                    return new oe(e, 
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Rn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, a = o.mutations; s < a.length; s++) {
                    ...
                    h = Vt.newInvalidDocument(c), r = r.insert(c, h)), Ke(u, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = gn(), i = 0, o = e; i < o.length; i++) for (var s = 0, a = o[i].mutations; s < a.length; s++) {
            var u = a[s];
            u instanceof He && null === n.get(u.key) && (r = r.add(u.key));
        }
        var c = n;
    ...
    return t.vn = function(e, n) {
        for (var r = gn(), i = gn(), o = 0, s = n.docChanges; o < s.length; o++) {
            var a = s[o];
            switch (a.type) {
              case 0 /* Added */ :
                r = r.add(a.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        }(e) || n.isEqual(tt.min()) ? this.Dn(t, e) : this.Sn.pn(t, r).next((function(o) {
            var s = i.Cn(e, o);
            return (ue(e) || ce(e)) && i.Nn(e.limitType, s, r, n) ? i.Dn(t, e) : (V() <= E.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ge(e)), 
    ...
    t.prototype.Nn = function(t, e, n, r) {
        ...
        return V() <= E.DEBUG && U("QueryEngine", "Using full collection scan to execute query:", ge(e)), 
        this.Sn.getDocumentsMatchingQuery(t, e, tt.min());
    }, t;
}(), $i = /** @class */ function() {
    function t(
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.On = tt.min(), this._n = t.getMutationQueue(n), this.Fn = t.getRemoteDocumentCache(), 
...
function Zi(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n._n, o = n.Mn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n._n.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        o = new Hi(n.Fn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var n = [], i = [], s = gn(), a = 0, u = r
 ...
 */ function to(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = Or.resolve();
 ...
 * queue.
 */ function no(t, e) {
    var n = W(t), r = e.snapshotVersion, i = n.kn;
     ...
     */
                    ...
                    }(a, c, e) && s.push(n.Ue.updateTargetData(t, c));
                }
            }
        }));
        var a = ln();
        ...
        s.push(ro(t, o, e.documentUpdates, r, void 0).next((function(t) {
            a = t;
        }))), !r.isEqual(tt.min())) {
            var u = n.Ue.getLastRemoteSnapshotVersion(t).next((function(e) {
                return n.Ue.setTargetsMetadata(t, t.currentSequenceNumber, r);
            }));
            s.push(u);
        }
        return Or.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Mn.En(t, a);
        })).next((function() {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            // cache.
                        s.isNoDocument() && s.version.isEqual(tt.min()) ? (
 ...
 */ function oo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.Ue.getTargetData(t, e).next((function(i) {
            ...
            r = i, Or.resolve(r)) : n.Ue.allocateTargetId(t).next((function(i) {
                return r = new Wr(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Ue.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function so(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = W(t), o = n.kn.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
 ...
 */ function ao(t, e, n) {
    var r = W(t), i = tt.min(), o = gn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.$n.get(n);
            return void 0 !== i ? Or.resolve(r.kn.get(i)) : r.Ue.getTargetData(e, n);
            ...
            return r.xn.getDocumentsMatchingQuery(t, e, n ? i : tt.min(), n ? o : gn());
        })).next((function(t) {
            return {
                documents: t,
                Bn: o
...
// PORTING NOTE: Multi-Tab only.
function uo(t, e) {
    var n = W(t), r = W(n.Ue), i = n.kn.get(e);
...
function co(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = ln(), o = $r(n), s = Vi(e), a = IDBKeyRange.lowerBound(o, !0);
            return s.Ot({
                index: br.readTimeIndex,
                range: a
            }, (function(t, e) {
 ...
 */ function fo(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = W(t), s = gn(), a = ln(), u = vn(), c = 0, h = i; c < h.length; c++) f = h[c], 
                l = e.Un(f.metadata.name), f.document && (s = s.add(l)), a = a.insert(l, e.qn(f)), 
                u = u.insert(l, e.Kn(f.metadata.readTime));
                return d = n.Fn.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , oo(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return pe(ae(ot.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return ro(t, d, a, tt.min(), u).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function lo(t, e, i) {
    return void 0 === i && (i = gn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , oo(t, pe(ii(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(ht.EMPTY_BYTE_STRING, r);
 ...
 */ var po = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Or.resolve(this.jn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return Or.resolve(this.Qn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.Wn = new cn(vo.Gn), 
        // A set of outstanding references to a document sorted by target id.
        this.zn = new cn(vo.Hn)
    ...
    t.prototype.Zn = function(t) {
        var e = this, n = new It(new ot([])), r = new vo(n, t), i = new vo(n, t + 1), o = [];
        ...
        var e = new It(new ot([])), n = new vo(e, t), r = new vo(e, t + 1), i = gn();
        return this.zn.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new vo(t, 0), n = this.Wn.firstAfterOrEqual(e);
    ...
    function t(t, e) {
        ...
        this.rs = new cn(vo.Gn);
    }
    return t.prototype.checkEmpty = function(t) {
        return Or.resolve(0 === this._n.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.ss;
        ...
        for (var s = 0, a = r; s < a.length; s++) {
            var u = a[s];
            this.rs = this.rs.add(new vo(u.key, i)), this.qt.addToCollectionParentIndex(t, u.key.path.popLast());
        }
        return Or.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return Or.resolve(this.os(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.cs(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Or.resolve(this._n.length > i ? this._n[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return Or.resolve(0 === this._n.length ? -1 : this.ss - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return Or.resolve(this._n.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new vo(e, 0), i = new vo(e, Number.POSITIVE_INFINITY), o = [];
        return this.rs.forEachInRange([ r, i ], (function(t) {
            var e = n.os(t.ns);
            o.push(e);
        })), Or.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new cn(X);
        return e.forEach((function(t) {
            var e = new vo(t, 0), i = new vo(t, Number.POSITIVE_INFINITY);
            n.rs.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.ns);
            }));
        })), Or.resolve(this.us(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new vo(new It(i), 0), s = new cn(X);
        ...
        var n = this;
        z(0 === this.hs(e.batchId, "removed")), this._n.shift();
        var r = this.rs;
        return Or.forEach(e.mutations, (function(i) {
            var o = new vo(i.key, e.batchId);
        ...
        var n = new vo(e, 0), r = this.rs.firstAfterOrEqual(n);
        return Or.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this._n.length, Or.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new sn(It.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return Or.resolve(n ? n.document.clone() : Vt.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = ln();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Vt.newInvalidDocument(t));
        })), Or.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = ln(), i = new It(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), a = s.key, u = s.value, c = u.document, h = u.readTime;
            if (!e.path.isPrefixOf(a.path)) break;
            h.compareTo(n) <= 0 || we(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return Or.resolve(r);
...
}(Li), bo = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.ds = new Oi((function(t) {
            return Bt(t);
        }), jt), 
        /** The last received snapshot version. */
        this.lastRemoteSnapshotVersion = tt.min(), 
        ...
        /**
             ...
             * IDs.
             */
        this._s = new yo, this.targetCount = 0, this.gs = Ii.Jt();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return Or.resolve(this.ws);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.gs.next(), Or.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        return this.te(e), this.targetCount += 1, Or.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.te(e), Or.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        return this.ds.delete(e.target), this._s.Zn(e.targetId), this.targetCount -= 1, 
        Or.resolve();
    }, t.prototype.removeTargets = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.ds.forEach((function(s, a) {
            a.sequenceNumber <= e && null === n.get(a.targetId) && (r.ds.delete(s), o.push(r.removeMatchingKeysForTargetId(t, a.targetId)), 
            i++);
        })), Or.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        ...
        return this._s.Jn(e, n), Or.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this._s.Xn(e, n);
        ...
        return this._s.Zn(e), Or.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this._s.es(e);
        return Or.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return Or.resolve(this._s.containsKey(e));
    }, t;
}(), Io = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        ...
        this.Ue = new bo(this), this.qt = new ui, this.qe = function(t, e) {
            return new go(t, (function(t) {
                return n.referenceDelegate.ps(t);
            }));
        }(this.qt), this.R = new Hr(e), this.Ke = new po(this.R);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new mo(this.qt, this.referenceDelegate), this.ys[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.Ue;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        return Or.or(Object.values(this.ys).map((function(n) {
            return function() {
    ...
    return t.Ps = function(e) {
        ...
        return this.As.addReference(n, e), this.bs.delete(n.toString()), Or.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.As.removeReference(n, e), this.bs.add(n.toString()), Or.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.bs.add(e.toString()), Or.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return Or.forEach(this.bs, (function(r) {
            var i = It.fromPath(r);
        ...
        return Or.or([ function() {
            return Or.resolve(n.As.containsKey(e));
        }, function() {
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function No(t, e, n) {
 ...
 */
// Visible for testing
/** A user with a null UID. */ So.UNAUTHENTICATED = new So(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
So.GOOGLE_CREDENTIALS = new So("google-credentials-uid"), So.FIRST_PARTY = new So("first-party-uid"), 
So.MOCK_USER = new So("mock-user");
...
var Ao = /** @class */ function() {
    ...
    return t.Vs = function(e, n, r) {
        ...
        return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new M(o.error.code, o.error.message))), 
    ...
    return t.Vs = function(e, n) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (r = new M(i.error.code, i.error.message))), 
    ...
    return t.Vs = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = bn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = bt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.$s = new sn(X), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Fs = _o(this.persistenceKey, this.Ns), 
        this.Ms = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.$s = this.$s.insert(this.Ns, new xo), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.gt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Ns && (o = this.getItem(_o(this.persistenceKey, i))) && (s = Co.Vs(i, o)) && (this.$s = this.$s.insert(s.clientId, s));
                    for (this.js(), (a = this.storage.getItem(this.qs)) && (u = this.Qs(a)) && this.Ws(u), 
        ...
        // `Window.addEventListener`.
            ...
            if (U("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Fs) return void B("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                ...
                return n(e, void 0, void 0, (function() {
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Ls.test(i.key)) {
                            ...
                            } else if (i.key === this.Ms) (a = function(t) {
                                var e = L.o;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue)) !== L.o && this.sequenceNumberHandler(a); else if (i.key === this.Ks) return [ 2 /*return*/ , this.syncEngine.ai() ];
                        } else this.Os.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new Ao(this.currentUser, t, e, n), i = No(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Ss());
    }, t.prototype.Hs = function(t) {
        var e = No(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    ...
    t.prototype.Qs = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.ci(t.batchId, t.state, t.error) ] : (U("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.$s.insert(t, e) : this.$s.remove(t), i = this.Gs(this.$s), o = this.Gs(r), s = [], a = [];
        return o.forEach((function(t) {
            i.has(t) || s.push(t);
    ...
    function t() {
        this.li = new xo, this.fi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.li = new xo, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.$i = function(t, e, n, r) {
            ...
            s.listenOnce(_.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case N.TIMEOUT:
                        U("Connection", 'RPC "' + t + '" timed out'), o(new M(P.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case N.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new M(a, r.message));
                            } else o(new M(P.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new M(P.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.Di, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = D(), i = A(), o = {
        ...
        this.useFetchStreams && (o.xmlHttpFactory = new k({})), this.ki(o.initMessageHeaders, e), 
        ...
        var s = n.join("");
        U("Connection", "Creating WebChannel: " + s, o);
        var a = r.createWebChannel(s, o), u = !1, c = !1, h = new Vo({
            Ei: function(t) {
                c ? U("Connection", "Not sending because WebChannel is closed:", t) : (u || (U("Connection", "Opening WebChannel transport."), 
                a.open(), u = !0), U("Connection", "WebChannel sending:", t), a.send(t));
            },
            Ti: function() {
                return a.close();
            }
        ...
        return f(a, C.EventType.OPEN, (function() {
            c || U("Connection", "WebChannel transport opened.");
        })), f(a, C.EventType.CLOSE, (function() {
            c || (c = !0, U("Connection", "WebChannel transport closed"), h.Vi());
        })), f(a, C.EventType.ERROR, (function(t) {
            c || (c = !0, j("Connection", "WebChannel transport errored:", t), h.Vi(new M(P.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    void 0 === s && (s = P.INTERNAL, u = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    c = !0, h.Vi(new M(s, u)), a.close();
                } else U("Connection", "WebChannel received:", n), h.Si(n);
            }
        })), f(i, R.STAT_EVENT, (function(t) {
            t.stat === x.PROXY ? U("Connection", "Detected buffering proxy") : t.stat === x.NOPROXY && U("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
    ...
    return t.prototype.Ni = function(t, e, n, r) {
        var i = this.xi(t, e);
        U("RestConnection", "Sending: ", i, n);
        var o = {};
        return this.ki(o, r), this.$i(t, i, o, n).then((function(t) {
            return U("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw j("RestConnection", t + " failed with error: ", e, "url: ", i, "request:", n), 
            e;
        }));
...
/** The Platform's 'document' implementation or null if not available. */ function Bo() {
 ...
 */ var Ko = /** @class */ function() {
    ...
    t.prototype.Qi = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && U("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ui + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    /** Sends a message to the underlying stream. */ t.prototype.ar = function(t) {
    ...
    /** Marks the stream as active again. */ t.prototype.cr = function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.Zi.ji()) : e && e.code === P.UNAUTHENTICATED && 
    ...
    t.prototype.ur = function() {}, t.prototype.auth = function() {
        ...
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
            ...
            e((function() {
                var e = new M(P.UNKNOWN, "Fetching auth token failed: " + n.message);
                return t.dr(e);
            }));
        }));
    ...
    t.prototype.dr = function(t) {
        ...
        return U("PersistentStream", "close with error: " + t), this.stream = null, this.close(3 /* Error */ , t);
    }, 
    /**
    ...
    t.prototype.hr = function(t) {
        ...
        return function(n) {
            e.Se.enqueueAndForget((function() {
                return e.Yi === t ? n() : (U("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.I ? (z(void 0 === e || "string" == typeof e), ht.fromBase64String(e || "")) : (z(void 0 === e || e instanceof Uint8Array), 
                    ht.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, a = s && function(t) {
                    var e = void 0 === t.code ? P.UNKNOWN : on(t.code);
                    return new M(e, t.message || "");
                }(s);
                n = new _n(r, i, o, a || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var u = e.documentChange;
                u.document, u.document.name, u.document.updateTime;
                var c = Un(t, u.document.name), h = Mn(u.document.updateTime), f = new Mt({
                    mapValue: {
                        fields: u.document.fields
                    }
                }), l = Vt.newFoundDocument(c, h, f), d = u.targetIds || [], p = u.removedTargetIds || [];
                n = new En(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Un(t, y.document), m = y.readTime ? Mn(y.readTime) : tt.min(), g = Vt.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new En([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = Un(t, b.document), T = b.removedTargetIds || [];
                n = new En([], T, I, null);
            } else {
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, _ = new nn(S), N = E.targetId;
                n = new Sn(N, _);
            }
            return n;
            ...
            if (!("targetChange" in t)) return tt.min();
            var e = t.targetChange;
            return e.targetIds && e.targetIds.length ? tt.min() : e.readTime ? Mn(e.readTime) : tt.min();
        }(t);
    ...
    n.prototype.mr = function(t) {
        ...
        e.database = Kn(this.R), e.addTarget = function(t, e) {
            ...
            return (n = Kt(r) ? {
                ...
                query: Xn(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Ln(t, e.resumeToken) : e.snapshotVersion.compareTo(tt.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = On(t, e.snapshotVersion.toTimestamp())), n;
        }(this.R, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
    ...
    n.prototype.gr = function(t) {
        var e = {};
        e.database = Kn(this.R), e.removeTarget = t, this.ar(e);
    }, n;
}(Go), Qo = /** @class */ function(e) {
    function n(t, n, r, i, o) {
        var s = this;
    ...
    n.prototype.start = function() {
        ...
        z(!!t.streamToken), this.lastStreamToken = t.streamToken, this.yr) {
        ...
        // The first response is always the handshake response
                return z(!t.writeResults || 0 === t.writeResults.length), this.yr = !0, 
        this.listener.Ir();
    }, 
    /**
    ...
    n.prototype.Ar = function() {
        ...
        var t = {};
        t.database = Kn(this.R), this.ar(t);
    }, 
    ...
    return t(n, e), n.prototype.Pr = function() {
        if (this.Rr) throw new M(P.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.Ni = function(t, e, n) {
        ...
        return this.Pr(), this.credentials.getToken().then((function(i) {
            ...
            throw "FirebaseError" === t.name ? (t.code === P.UNAUTHENTICATED && r.credentials.invalidateToken(), 
            t) : new M(P.UNKNOWN, t.toString());
        }));
    }, 
    ...
    t.prototype.set = function(t) {
        ...
        this.Vr ? (B(e), this.Vr = !1) : U("OnlineStateTracker", e);
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Fr.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , $o(e) ];
 ...
 */ function Zo(t, e) {
    var n = W(t), r = ws(n);
    n.Or.delete(e), r.er() && es(n, e), 0 === n.Or.size && (r.er() ? r.ir() : is(n) && 
...
function rs(t) {
    return is(t) && !ws(t).tr() && t.Or.size > 0;
}

function is(t) {
    return 0 === W(t).Fr.size;
}
...
function us(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(u) {
            switch (u.label) {
              case 0:
                if (t.Br.set("Online" /* Online */), !(e instanceof _n && 2 /* Removed */ === e.state && e.cause)) 
              ...
              case 6:
                if (e instanceof En ? t.Ur.X(e) : e instanceof Sn ? t.Ur.rt(e) : t.Ur.et(e), i.isEqual(tt.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;

              case 7:
                return u.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , eo(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.Or.set(e, n.withResumeToken(ht.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new Wr(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            ts(t, r);
                        }
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", a = u.sent()), [ 4 /*yield*/ , cs(t, a) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Fr.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , $o(t) ];
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Fr.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Xo(t) ];
...
function fs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = W(t), n = bs(e), i = e.$r.length > 0 ? e.$r[e.$r.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , io(e.localStore, i) ];
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , cs(e, s) ];
...
function ls(t) {
    return is(t) && !bs(t).tr() && t.$r.length > 0;
}
...
function ys(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = bs(t), n = 0, i = t.$r; n < i.length; n++) o = i[n], e.Er(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function vs(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.$r.shift(), o = Qr.from(n, e, i), [ 4 /*yield*/ , hs(t, (function() {
...
function ms(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && bs(t).pr ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return rn(i = e.code) && i !== P.ABORTED ? (n = t.$r.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                bs(t).sr(), [ 4 /*yield*/ , hs(t, (function() {
 ...
 */ function gs(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), e ? (n.Fr.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Xo(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.Fr.add(2 /* IsSecondary */), [ 4 /*yield*/ , $o(n) ]);
 ...
 */ function ws(t) {
    ...
    t.qr = function(t, e, n) {
        var r = W(t);
        return r.Pr(), new zo(e, r.Hi, r.credentials, r.R, n);
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.qr.sr(), rs(t) ? ns(t) : t.Br.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];
    ...
    t.Kr = function(t, e, n) {
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Kr.sr(), [ 4 /*yield*/ , fs(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.$r.length > 0 && (U("RemoteStore", "Stopping write stream with " + t.$r.length + " pending writes"), 
                    t.$r = []), e.label = 4;
...
var Is = /** @class */ function() {
    function t(t, e, n, r, i) {
        ...
        this.deferred = new xr, this.then = this.deferred.promise.then.bind(this.deferred.promise), 
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new M(P.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function Ts(t, e) {
    if (B("AsyncQueue", e + ": " + t), Vr(t)) return new M(P.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Es = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = pn(), this.sortedSet = new sn(this.comparator)
        /**
    ...
    this.queries = new Oi((function(t) {
        return me(t);
    }), ve), this.onlineState = "Unknown" /* Unknown */ , this.Gr = new Set;
};
 ...
 */ function As(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = W(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new Ns), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 2:
                return a.Wr = r.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return u = r.sent(), c = Ts(u, "Initialization of query '" + ge(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.zr(n.onlineState), s.Wr && e.Hr(s.Wr) && xs(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Os = /** @class */ function() {
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.zr = function(t) {
        ...
        t = _s.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Yr = !0, 
        this.Jr.next(t);
    }, t;
}(), Ls = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.qn = function(t) {
        return t.metadata.exists ? Qn(this.R, t.document, !1) : Vt.newNoDocument(this.Un(t.metadata.name), this.Kn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Fs(t)
        /**
    ...
    return t.prototype.oo = function(t) {
        ...
        for (var e = new Map, n = new Ps(this.R), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
            if (o.metadata.queries) for (var s = n.Un(o.metadata.name), a = 0, u = o.metadata.queries; a < u.length; a++) {
                var c = u[a], h = (e.get(c) || gn()).add(s);
                e.set(c, h);
            }
        }
        return e;
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , fo(this.localStore, new Ps(this.R), this.documents, this.ro.id) ];

                  case 1:
                    t = r.sent(), e = this.ao(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , lo(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
 ...
 */ var Vs = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = gn(), this.lo = be(t), this.fo = new Es(this.lo);
    }
    ...
    t.prototype._o = function(t, e) {
        var n = this, r = e ? e.mo : new Ss, i = e ? e.fo : this.fo, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, a = !1, u = ue(this.query) && i.size === this.query.limit ? i.last() : null, c = ce(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), f = we(n.query, e) ? e : null, l = !!h && n.mutatedKeys.has(h.key), d = !!f && (f.hasLocalMutations || 
            ...
            o = o.delete(t)));
        })), ue(this.query) || ce(this.query)) for (;s.size > this.query.limit; ) {
            var h = ue(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        var s = e ? this.Eo() : [], a = 0 === this.ho.size && this.current ? 1 /* Synced */ : 0 /* Local */ , u = a !== this.uo;
        return this.uo = a, 0 !== o.length || u ? {
            snapshot: new _s(this.query, t.fo, i, o, t.mutatedKeys, 0 /* Local */ === a, u, 
            /* excludesMetadataChanges= */ !1),
            To: s
        } : {
            To: s
    ...
    t.prototype.po = function(t) {
        ...
        // updating many documents.
                var e = this.ho;
        this.ho = gn(), this.fo.forEach((function(e) {
            t.Io(e.key) && (t.ho = t.ho.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.ho.has(e) || n.push(new qs(e));
        })), this.ho.forEach((function(t) {
            e.has(t) || n.push(new Vs(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.Ro = function() {
        return _s.fromInitialDocuments(this.query, this.fo, this.mutatedKeys, 0 /* Local */ === this.uo);
    }, t;
}(), Bs = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.bo = {}, this.vo = new Oi((function(t) {
            return me(t);
        }), ve), this.Vo = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.Do = new sn(It.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Co = new Map, this.No = new yo, 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return [ 4 /*yield*/ , oo(n.localStore, pe(e)) ];
              ...
              case 3:
                o = r.sent(), n.isPrimaryClient && Jo(n.remoteStore, a), r.label = 4;
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view._o(i), n.Nn ? [ 4 /*yield*/ , ao(t.localStore, e.query, 
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (ia(t, e.targetId, a.To), 
                                    a.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , ao(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = l.sent(), a = new Us(e, s.Bn), u = a._o(s.documents), c = Tn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = a.applyChanges(u, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), ia(t, i, h.To), f = new Bs(e, i, a), 
...
/** Stops listening to the query. */ function Qs(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n.vo.get(e), (o = n.Vo.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Vo.set(i.targetId, o.filter((function(t) {
                    return !ve(t, e);
                }))), void n.vo.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , so(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), Zo(n.remoteStore, i.targetId), 
                    na(n, i.targetId);
                })).catch(Ni) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return na(n, i.targetId), [ 4 /*yield*/ , so(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = W(t), i = Z.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), gn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Mn.pn(t, o).next((function(o) {
                            ...
                            var s = [], a = 0, u = e; a < u.length; a++) {
                                var c = u[a], h = Ge(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new He(c.key, h, Ft(h.value.mapValue), qe.exists(!0)));
                            }
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    ...
                    r || (r = new sn(X)), r = r.insert(e, n), t.xo[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , aa(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , fs(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), a = Ts(s, "Failed to persist write"), i.reject(a), [ 3 /*break*/ , 6 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , no(n.localStore, e) ];
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.Po = !0 : t.modifiedDocuments.size > 0 ? z(r.Po) : t.removedDocuments.size > 0 && (z(r.Po), 
                    r.Po = !1));
                })), [ 4 /*yield*/ , aa(n, i, e) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = W(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Co.get(e), 
                (s = o && o.key) ? (a = (a = new sn(It.comparator)).insert(s, Vt.newNoDocument(s, tt.min())), 
                u = gn().add(s), c = new In(tt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new cn(X), a, u), [ 4 /*yield*/ , Hs(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Do = n.Do.remove(s), n.Co.delete(e), sa(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , so(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return na(n, e, i);
                })).catch(Ni) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , to(n.localStore, e) ];
              ...
              case 2:
                ...
                ea(n, i, /*error=*/ null), ta(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , aa(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n._n.lookupMutationBatch(t, e).next((function(e) {
                            return z(null !== e), r = e.keys(), n._n.removeMutationBatch(t, e);
                        })).next((function() {
                            return n._n.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Mn.pn(t, r);
              ...
              case 2:
                ...
                // listen events.
                ea(n, e, i), ta(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , aa(n, o) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 3:
                return s = r.sent(), a = Ts(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function ea(t, e, n) {
    var r = W(t), i = r.xo[r.currentUser.toKey()];
...
function ra(t, e) {
    ...
    var n = t.Do.get(e);
    null !== n && (Zo(t.remoteStore, n), t.Do = t.Do.remove(e), t.Co.delete(n), sa(t));
}

function ia(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Vs ? (t.No.addReference(o.key, e), oa(t, o)) : o instanceof qs ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function oa(t, e) {
    ...
    t.Do.get(n) || t.So.has(r) || (U("SyncEngine", "New document in limbo: " + n), t.So.add(r), 
    sa(t));
}
 ...
 */ function sa(t) {
    for (;t.So.size > 0 && t.Do.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.So.delete(e);
        var n = new It(ot.fromString(e)), r = t.$o.next();
        t.Co.set(r, new js(n)), t.Do = t.Do.insert(n, r), Jo(t.remoteStore, new Wr(pe(ae(n.path)), r, 2 /* LimboResolution */ , L.o));
    }
}
...
function aa(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), s = [], a = [], u = [], o.vo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.vo.forEach((function(t, n) {
                    u.push(o.Fo(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = Yi.vn(n.targetId, t);
                            a.push(e);
                        }
                    })));
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Or.forEach(e, (function(e) {
                                        return Or.forEach(e.Pn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return Or.forEach(e.bn, (function(r) {
                              ...
                              case 4:
                                for (o = 0, s = e; o < s.length; o++) a = s[o], u = a.targetId, a.fromCache || (c = n.kn.get(u), 
                                h = c.snapshotVersion, f = c.withLastLimboFreeSnapshotVersion(h), 
                                // Advance the last limbo free snapshot version
                                n.kn = n.kn.insert(u, f));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
              ...
              case 1:
                ...
                function(t, e) {
                    t.ko.forEach((function(t) {
                        t.forEach((function(t) {
                            t.reject(new M(P.CANCELLED, "'waitForPendingWrites' promise is rejected due to a user change."));
                        }));
                    })), t.ko.clear();
                }(n), 
                // TODO(b/114226417): Consider calling this only in the primary tab.
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , aa(n, i.Ln) ];
...
function ca(t, e) {
    var n = W(t), r = n.Co.get(e);
    if (r && r.Po) return gn().add(r.key);
    var i = gn(), o = n.Vo.get(e);
    if (!o) return i;
    for (var s = 0, a = o; s < a.length; s++) {
        var u = a[s], c = n.vo.get(u);
 ...
 */ function ha(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , ao((n = W(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.Ao(i), [ 2 /*return*/ , (n.isPrimaryClient && ia(n, e.targetId, o.To), 
                o) ];
            }
        }));
    }));
...
function fa(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , co((e = W(t)).localStore).then((function(t) {
                return aa(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Qt(t, e).next((function(e) {
                            return e ? n.Mn.pn(t, e) : Or.resolve(null);
                        }));
                    }));
                }((n = W(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , fs(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                ea(n, e, o || null), ta(n, e), function(t, e) {
                    W(W(t)._n).Gt(e);
                }(n.localStore, e)) : G(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , aa(n, s) ];
...
function da(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return wa(n = W(t)), ba(n), !0 !== e || !0 === n.Oo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , pa(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Oo = !0, [ 4 /*yield*/ , gs(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, a = o; s < a.length; s++) u = a[s], Jo(n.remoteStore, u);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                n.Vo.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return na(n, e), so(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), Zo(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , pa(n, c) ];
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.Co.forEach((function(t, n) {
                        Zo(e.remoteStore, n);
                    })), e.No.ts(), e.Co = new Map, e.Do = new sn(It.comparator);
                }(n), n.Oo = !1, [ 4 /*yield*/ , gs(n.remoteStore, !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return s < a.length ? (u = a[s], c = void 0, (h = n.Vo.get(u)) && 0 !== h.length ? [ 4 /*yield*/ , oo(n.localStore, pe(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.vo.get(d), [ 4 /*yield*/ , ha(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , uo(n.localStore, u) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , oo(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , zs(n, ya(v), u, 
                /*current=*/ !1) ];
...
function va(t) {
    var e = W(t);
    return W(W(e.localStore).persistence).fn();
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                return [ 4 /*yield*/ , co(n.localStore) ];

              case 3:
                return s = r.sent(), a = In.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , aa(n, s, a) ];
              ...
              case 6:
                return r.sent(), na(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function ga(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, a, u, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = wa(t)).Oo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (a = s[o], n.Vo.has(a) ? (
                // A target might have been added in a previous attempt
                U("SyncEngine", "Adding an already active target " + a), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , uo(n.localStore, a) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return u = p.sent(), [ 4 /*yield*/ , oo(n.localStore, u) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , zs(n, ya(u), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), Jo(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Vo.has(t) ? [ 4 /*yield*/ , so(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                Zo(n.remoteStore, t), na(n, t);
                            })).catch(Ni) ] : [ 3 /*break*/ , 2 ];
...
function wa(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Hs.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ca.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Xs.bind(null, e), e.bo._r = Cs.bind(null, e.eventManager), 
    e.bo.Mo = Rs.bind(null, e.eventManager), e;
}

function ba(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = $s.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = Js.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Fs(n)), o = new Ms(n, t.localStore, e.R), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 7:
                    return (a = r.sent()) && i._updateProgress(a), [ 4 /*yield*/ , e.Lo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = r.sent(), [ 4 /*yield*/ , aa(t, u.wn, 
                    /* remoteEvent */ void 0) ];
...
var Ta = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.R = jo(t.databaseInfo.databaseId), this.sharedClientState = this.Bo(t), 
        ...
        return Ji(this.persistence, new Xi, t.initialUser, this.R);
    }, t.prototype.Uo = function(t) {
        return new Io(Eo.Ps, this.R);
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , ho(this.localStore) ];
                  ...
                  case 3:
                    ...
                    return r.sent(), [ 4 /*yield*/ , ba(this.jo.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , fs(this.jo.remoteStore) ];
        ...
        var e = Qi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? di.withCacheSize(this.cacheSizeBytes) : di.DEFAULT;
        return new Ki(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Uo(), Bo(), this.R, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.Bo = function(t) {
        return new Lo;
    }, i;
}(Ta), Sa = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.jo.syncEngine, this.sharedClientState instanceof Oo ? (this.sharedClientState.syncEngine = {
                        ci: la.bind(null, i),
                        ui: ma.bind(null, i),
                        hi: ga.bind(null, i),
                        fn: va.bind(null, i),
                    ...
                    return [ 4 /*yield*/ , this.persistence.He((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , da(this.jo.syncEngine, t) ];
        ...
        var e = Uo();
        if (!Oo.gt(e)) throw new M(P.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Qi(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new Oo(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(Ea), _a = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Ys(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = ua.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , gs(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = jo(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new qo(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Ys(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Mo.gt() ? new Mo : new Po, new Yo(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var a = new Ks(t, e, n, r, i, o);
            return s && (a.Oo = !0), a;
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = W(t), U("RemoteStore", "RemoteStore shutting down."), e.Fr.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , $o(e) ];
 ...
 */ var Da = /** @class */ function() {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new Ls(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.Jo = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Zo() < 0 ? [ 4 /*yield*/ , this.ta() ] : [ 3 /*break*/ , 3 ];
    ...
    t.prototype.Xo = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.ta() ] : [ 3 /*break*/ , 3 ];
    ...
    return t.prototype.lookup = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new M(P.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            var n, i, o, s, a, u;
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = W(t), i = Kn(n.R) + "/documents", o = {
                                    ...
                                    return s = r.sent(), a = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Un(t, e.found.name), r = Mn(e.found.updateTime), i = new Mt({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Vt.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                z(!!e.missing), z(!!e.readTime);
                                                var n = Un(t, e.missing), r = Mn(e.readTime);
                                                return Vt.newNoDocument(n, r);
                                            }(t, e) : G();
                                        }(n.R, t);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = It.fromPath(n);
                        e.mutations.push(new en(r, e.precondition(r)));
        ...
        if (n) {
            ...
            throw new M(P.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new M(P.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        ...
        this.ea = 5, this.Zi = new Ko(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.Zi.Qi((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new ka(this.datastore), (e = this.sa(t)) && e.then((function(e) {
        ...
        var e = this;
        this.ea > 0 && this.ra(t) ? (this.ea -= 1, this.asyncQueue.enqueueAndForget((function() {
    ...
    e, i) {
        var o = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = i, this.user = So.UNAUTHENTICATED, 
        this.clientId = Y.u(), this.credentialListener = function() {
            return Promise.resolve();
            ...
            return n(o, void 0, void 0, (function() {
                return r(this, (function(e) {
                    switch (e.label) {
                      case 0:
                        return U("FirestoreClient", "Received user=", t.uid), [ 4 /*yield*/ , this.credentialListener(t) ];
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new M(P.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
                ...
                return a.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Zi(e.localStore, t) ];
...
function Oa(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , La(t) ];
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    ...
                                    n.Fr.add(3 /* CredentialChange */), [ 4 /*yield*/ , $o(n) ];
                                  ...
                                  case 2:
                                    return r.sent(), n.Fr.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Xo(n) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Gs.bind(null, e.syncEngine), 
                n.onUnlisten = Qs.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}

/** Enables the network connection and re-enqueues all pending operations. */ function Ba(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new xr;
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Da({
                            next: function(o) {
                                ...
                                i.reject(new M(P.UNAVAILABLE, "Failed to get document because the client is offline.")) : a && o.fromCache && r && "server" === r.source ? i.reject(new M(P.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(o);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
                        }), s = new Os(ae(n.path), o, {
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Da({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return ks(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new M(P.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
...
function(t, e, n, r, i, o, s, a) {
    ...
    function t(t) {
        var e = this;
        /** Tracks the current User. */        this.currentUser = So.UNAUTHENTICATED, 
        ...
        /**
             ...
             * outstanding.
             */
        this.aa = 0, this.forceRefresh = !1, this.auth = null, this.asyncQueue = null, this.ca = function() {
            e.aa++, e.currentUser = e.ua(), e.oa.resolve(), e.changeListener && e.asyncQueue.enqueueRetryable((function() {
                return e.changeListener(e.currentUser);
            }));
        };
        var n = function(t) {
            U("FirebaseCredentialsProvider", "Auth detected"), e.auth = t, e.auth.addAuthTokenListener(e.ca);
        };
        t.onInit((function(t) {
            return n(t);
        })), 
        ...
        setTimeout((function() {
            if (!e.auth) {
                ...
                U("FirebaseCredentialsProvider", "Auth not yet detected"), e.oa.resolve());
            }
        }), 0);
    }
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            return t.aa !== e ? (U("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (z("string" == typeof n.accessToken), new Qa(n.accessToken, t.currentUser)) : null;
        ...
        this.asyncQueue.enqueueRetryable((function() {
            return n(i, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return [ 4 /*yield*/ , this.oa.promise ];
        ...
        this.auth && this.auth.removeAuthTokenListener(this.ca), this.changeListener = function() {
            return Promise.resolve();
        };
    }, 
    ...
    t.prototype.ua = function() {
        ...
        return z(null === t || "string" == typeof t), new So(t);
    }, t;
}(), Xa = /** @class */ function() {
    function t(t, e, n) {
        this.ha = t, this.la = e, this.fa = n, this.type = "FirstParty", this.user = So.FIRST_PARTY;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Xa(this.ha, this.la, this.fa));
    }, t.prototype.setChangeListener = function(t, e) {
        // Fire with initial uid.
        t.enqueueRetryable((function() {
            return e(So.FIRST_PARTY);
        }));
 ...
 */
function Ja(t, e, n) {
    if (!n) throw new M(P.INVALID_ARGUMENT, "Function " + t + "() cannot be called with an empty " + e + ".");
}
 ...
 * @internal
 */ function Za(t, e, n, r) {
    if (!0 === e && !0 === r) throw new M(P.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function tu(t) {
    if (!It.isDocumentKey(t)) throw new M(P.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function eu(t) {
    if (It.isDocumentKey(t)) throw new M(P.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new M(P.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = nu(t);
        throw new M(P.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function iu(t, e) {
    if (e <= 0) throw new M(P.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var ou = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new M(P.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new M(P.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    function t(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof Ga ? (this._databaseId = t, this._credentials = new Wa) : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new M(P.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
            return new Ga(t.options.projectId);
        }(t), this._credentials = new Ya(e));
    }
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new M(P.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new M(P.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new ou(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              case "gapi":
                ...
                new $a(e, t.sessionIndex || "0", t.iamToken || null);

              case "provider":
                return t.client;

              default:
                throw new M(P.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = za.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
 ...
 */ function au(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        var s, a;
        if ("string" == typeof r.mockUserToken) s = r.mockUserToken, a = So.MOCK_USER; else {
            // Let createMockUserToken validate first (catches common mistakes like
            // invalid field "uid" and missing field "sub" / "user_id".)
            s = w(r.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
            var u = r.mockUserToken.sub || r.mockUserToken.user_id;
            if (!u) throw new M(P.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            a = new So(u);
        }
        t._credentials = new Ha(new Qa(s, a));
    }
}
 ...
 */ var uu = /** @class */ function() {
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, ae(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function fu(t, n) {
    ...
    if (t = b(t), Ja("collection", "path", n), t instanceof su) {
        var o = ot.fromString.apply(ot, e([ n ], r));
        return eu(o), new hu(t, /* converter= */ null, o);
    }
    if (!(t instanceof uu || t instanceof hu)) throw new M(P.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = ot.fromString.apply(ot, e([ t.path ], r)).child(ot.fromString(n));
 ...
 */ function lu(t, e) {
    if (t = ru(t, su), Ja("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new M(P.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new cu(t, 
    /* converter= */ null, 
    /**
...
function du(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = Y.u()), Ja("doc", "path", n), t instanceof su) {
        var o = ot.fromString.apply(ot, e([ n ], r));
        return tu(o), new uu(t, 
        /* converter= */ null, new It(o));
    }
    if (!(t instanceof uu || t instanceof hu)) throw new M(P.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(ot.fromString.apply(ot, e([ n ], r)));
    return tu(s), new uu(t.firestore, t instanceof hu ? t.converter : null, new It(s));
}
...
function yu(t, e) {
    return t = b(t), e = b(e), t instanceof cu && e instanceof cu && t.firestore === e.firestore && ve(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var vu = /** @class */ function() {
    function t() {
        ...
        this.Zi = new Ko(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Ta = function() {
            var e = Bo();
            e && U("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.Zi.Gi();
        };
        var e = Bo();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Ta);
    }
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        // advance the queue even when the operation is not run.
                var n = new xr;
        return this.Aa((function() {
            return e._a && e.pa ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Ra = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.wa.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.wa[0]() ];

                  case 2:
                    return n.sent(), this.wa.shift(), this.Zi.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.da.then((function() {
            return e.ya = !0, t().catch((function(t) {
                // Re-throw the error so that this.tail becomes a rejected Promise and
                // all further attempts to chain (via .then) will just short-circuit
                // and return the rejected Promise.
                throw e.ga = t, e.ya = !1, B("INTERNAL UNHANDLED ERROR: ", 
                /**
 ...
 */
    ...
    t.prototype.ba = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.da ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.da) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
    ...
    t.prototype.va = function(t) {
        for (var e = 0, n = this.ma; e < n.length; e++) {
    ...
    t.prototype.Va = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e.ma.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.ma; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.Pa = function(t) {
        // NOTE: indexOf / slice are O(n), but delayedOperations is expected to be small.
        var e = this.ma.indexOf(t);
        this.ma.splice(e, 1);
    }, t;
}();
...
var gu = /** @class */ function() {
    function t() {
        this._progressObserver = {}, this._taskCompletionResolver = new xr, this._lastProgress = {
            taskState: "Running",
            totalBytes: 0,
            totalDocuments: 0,
            bytesLoaded: 0,
...
function Iu(t, e) {
    var n = i(t, "firestore");
    if (n.isInitialized()) {
        var r = n.getImmediate(), o = n.getOptions();
        if (I(o, e)) return r;
        throw new M(P.FAILED_PRECONDITION, "initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.");
    }
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new M(P.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return n.initialize({
        options: e
    });
}
 ...
 */ function Tu(t) {
    return void 0 === t && (t = o()), i(t, "firestore").getImmediate();
}
...
function Su(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Ka(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Ra(t._credentials, t._queue, r);
}
 ...
 */ function _u(t, e) {
    Pu(t = ru(t, bu));
    var n = Eu(t), r = t._freezeSettings(), i = new _a;
    return Du(n, i, new Ea(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Nu(t) {
    Pu(t = ru(t, bu));
    var e = Eu(t), n = t._freezeSettings(), r = new _a;
    return Du(e, r, new Sa(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , xa(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Oa(t, e) ];
...
function Au(t) {
    var e = this;
    if (t._initialized && !t._terminated) throw new M(P.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    var i = new xr;
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return Pr.gt() ? (e = t + "main", [ 4 /*yield*/ , Pr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Qi(t._databaseId, t._persistenceKey)) ];
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Va(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.Fr.delete(0 /* UserDisabled */), Xo(e);
                        }(n)) ];
                    }
                }));
            }));
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Fr.add(0 /* UserDisabled */), [ 4 /*yield*/ , $o(e) ];
 ...
 * terminated.
 */ function xu(t) {
    return s(t.app, "firestore"), t._delete()
    /**
...
function Pu(t) {
    if (t._initialized || t._terminated) throw new M(P.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var Mu = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new M(P.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
 ...
 */ var Vu = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            ...
            throw new M(P.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new M(P.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new M(P.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
}(), Bu = /^__.*__$/, ju = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new He(t, this.data, this.fieldMask, e, this.fieldTransforms) : new We(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Ku = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.toMutation = function(t, e) {
        return new He(t, this.data, this.fieldMask, e, this.fieldTransforms);
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var zu = /** @class */ function() {
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Da(), this.fieldTransforms = i || [], this.fieldMask = o || [];
    }
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Na = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.Na({
            path: n,
            ka: !1
        });
        return r.$a(t), r;
        ...
        return fc(t, this.settings.methodName, this.settings.La || !1, this.path, this.settings.Ba);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.$a(this.path.get(t));
    }, t.prototype.$a = function(t) {
        if (0 === t.length) throw this.Ma("Document fields must not be empty");
        if (Gu(this.Ca) && Bu.test(t)) throw this.Ma('Document fields cannot begin and end with "__"');
    }, t;
}(), Qu = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.R = n || jo(t)
 ...
 * classes.
 */ function Wu(t) {
    var e = t._freezeSettings(), n = jo(t._databaseId);
    return new Qu(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Hu(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Ua(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    ac("Data must be an object, but it was:", s, r);
    var a, u, c = oc(r, s);
    if (o.merge) a = new ut(s.fieldMask), u = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = uc(e, l[f], n);
            if (!s.contains(d)) throw new M(P.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            lc(h, d) || h.push(d);
        }
        a = new ut(h), u = s.fieldTransforms.filter((function(t) {
            return a.covers(t.field);
        }));
    } else a = null, u = s.fieldTransforms;
    return new ju(new Mt(c), a, u);
}
...
var $u = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).Ka = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Le(t.R, Se(t.R, this.Ka));
...
/** Parse update data from a list of field/value arguments. */ function nc(t, e, n, r, i, o) {
    var s = t.Ua(1 /* Update */ , e, n), a = [ uc(e, r, n) ], u = [ i ];
    if (o.length % 2 != 0) throw new M(P.INVALID_ARGUMENT, "Function " + e + "() needs to be called with an even number of arguments that alternate between field names and values.");
    for (var c = 0; c < o.length; c += 2) a.push(uc(e, o[c])), u.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = Mt.empty(), l = a.length - 1; l >= 0; --l) if (!lc(h, a[l])) {
        var d = a[l], p = u[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = b(p);
 ...
 */ function rc(t, e, n, r) {
    return void 0 === r && (r = !1), ic(n, t.Ua(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function ic(t, e) {
    ...
    return function(t, e) {
        ...
        if (!Gu(e.Ca)) throw e.Ma(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Se(e.R, t);
        ...
        if (t instanceof Vu) return {
            bytesValue: Ln(e.R, t._byteString)
        };
        if (t instanceof uu) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.Ma("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: Fn(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Ma("Unsupported field value: " + nu(t));
    }(t, e);
}
...
function oc(t, e) {
    ...
    e.path && e.path.length > 0 && e.fieldMask.push(e.path) : nt(t, (function(t, r) {
        var i = ic(r, e.xa(t));
        null != i && (n[t] = i);
    })), {
        mapValue: {
...
function sc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof Z || t instanceof Uu || t instanceof Vu || t instanceof uu || t instanceof qu);
}
...
function ac(t, e, n) {
    if (!sc(n) || !function(t) {
        ...
        var r = nu(n);
        throw "an object" === r ? e.Ma(t + " a custom object") : e.Ma(t + " " + r);
    }
}
 ...
 */ function uc(t, e, n) {
    ...
    // FieldPath.
    (e = b(e)) instanceof Mu) return e._internalPath;
 ...
 */ function hc(t, n, r) {
    ...
    /* path= */ void 0, r);
    try {
        return (new (Mu.bind.apply(Mu, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
...
function fc(t, e, n, r, i) {
    ...
    u += ")"), new M(P.INVALID_ARGUMENT, (a += ". ") + t + u)
 ...
 */
function yc(t, e) {
    return "string" == typeof e ? hc(t, e) : e instanceof Mu ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var vc = /** @class */ function() {
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new M(P.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 * limitations under the License.
 */ function Tc(t) {
    if (ce(t) && 0 === t.explicitOrderBy.length) throw new M(P.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var _c = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).ja = t, i.Qa = n, i.Wa = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Wu(t.firestore), n = function(t, e, n, r, i, o, s) {
            var a;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new M(P.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
            ...
            var l = Gt.create(i, o, a);
            return function(t, e) {
                if (e.g()) {
                    var n = fe(t);
                    if (null !== n && !n.isEqual(e.field)) throw new M(P.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, !=, not-in, >, or >=) must be on the same field. But you have inequality filters on '" + n.toString() + "' and '" + e.field.toString() + "'");
                    var r = he(t);
 ...
 */
                ...
                throw i === e.op ? new M(P.INVALID_ARGUMENT, "Invalid query. You cannot use more than one '" + e.op.toString() + "' filter.") : new M(P.INVALID_ARGUMENT, "Invalid query. You cannot use '" + e.op.toString() + "' filters with '" + i.toString() + "' filters.");
            }(t, l), l;
        }(t._query, 0, e, t.firestore._databaseId, this.ja, this.Qa, this.Wa);
...
var Dc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).ja = t, r.Ga = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new M(P.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new M(P.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new ee(e, n);
            return function(t, e) {
                if (null === he(t)) {
...
var kc = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.za = n, i.Ha = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        return new cu(t.firestore, t.converter, ye(t._query, this.za, this.Ha));
    }, n;
}(Ec);
...
var xc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        var e = Vc(t, this.type, this.Ja, this.Ya);
        return new cu(t.firestore, t.converter, function(t, e) {
...
/** Helper function to create a bound from a document or fields */ function Vc(t, e, n, r) {
    if (n[0] = b(n[0]), n[0] instanceof dc) return function(t, e, n, r, i) {
        if (!r) throw new M(P.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        // results.
        for (var o = [], s = 0, a = de(t); s < a.length; s++) {
            var u = a[s];
            if (u.field.isKeyField()) o.push(kt(e, r.key)); else {
                var c = r.data.field(u.field);
                if (yt(c)) throw new M(P.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = u.field.canonicalString();
                    throw new M(P.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    var i = Wu(t.firestore);
    return function(t, e, n, r, i, o) {
        // Use explicit order by's because it has to match the query the user made
        var s = t.explicitOrderBy;
        if (i.length > s.length) throw new M(P.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var a = [], u = 0; u < i.length; u++) {
            var c = i[u];
            if (s[u].field.isKeyField()) {
                if ("string" != typeof c) throw new M(P.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!le(t) && -1 !== c.indexOf("/")) throw new M(P.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(ot.fromString(c));
                if (!It.isDocumentKey(h)) throw new M(P.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new It(h);
                a.push(kt(e, f));
            } else {
                var l = rc(n, r, c);
...
function qc(t, e, n) {
    if ("string" == typeof (n = b(n))) {
        if ("" === n) throw new M(P.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!le(e) && -1 !== n.indexOf("/")) throw new M(P.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(ot.fromString(n));
        if (!It.isDocumentKey(r)) throw new M(P.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return kt(t, new It(r));
    }
    if (n instanceof uu) return kt(t, n._key);
    throw new M(P.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + nu(n) + ".");
}
 ...
 * array requirements.
 */ function Uc(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new M(P.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
    if (t.length > 10) throw new M(P.INVALID_ARGUMENT, "Invalid Query. '" + e.toString() + "' filters support a maximum of 10 elements in the value array.");
}

function Bc(t, e, n) {
    if (!n.isEqual(e)) throw new M(P.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality (<, <=, !=, not-in, >, or >=) on field '" + e.toString() + "' and so you must also use '" + e.toString() + "' as your first argument to orderBy(), but your first orderBy() is on field '" + n.toString() + "' instead.");
}
 ...
 */ var jc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new Uu(dt(t.latitude), dt(t.longitude));
        ...
        var n = ot.fromString(t);
        z(ur(n));
        var r = new Ga(n.get(1), n.get(3)), i = new It(n.popFirst(5));
        return r.isEqual(e) || 
...
var Gc = /** @class */ function(e) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Qc(t, this._firestore), i = Kc(r.converter, e, n), o = Hu(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Mu ? nc(this._dataReader, "WriteBatch.update", s._key, e, n, r) : ec(this._dataReader, "WriteBatch.update", s._key, e), 
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new tn(e._key, qe.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new M(P.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function Qc(t, e) {
    if ((t = b(t)).firestore !== e) throw new M(P.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function Wc(t) {
    ...
    return Ba(Eu(e), t._key).then((function(n) {
        return ah(e, t, n);
    }));
}
 ...
 */ function Yc(t) {
    t = ru(t, uu);
    var e = ru(t.firestore, bu), i = Eu(e), o = new Hc(e);
    return function(t, e) {
        var i = this, o = new xr;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return (n = r.sent()).isFoundDocument() ? i.resolve(n) : n.isNoDocument() ? i.resolve(null) : i.reject(new M(P.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = r.sent(), s = Ts(o, "Failed to get document '" + e + " from cache"), 
 ...
 */ function $c(t) {
    t = ru(t, cu);
    var e = ru(t.firestore, bu), n = Eu(e), r = new Hc(e);
    return Tc(t._query), ja(n, t._query).then((function(n) {
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , ao(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Us(e, n.Bn), s = o._o(n.documents), a = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(a.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return u = r.sent(), c = Ts(u, "Failed to execute query '" + e + " against cache"), 
...
function th(t, e, n) {
    t = ru(t, uu);
    var r = ru(t.firestore, bu), i = Kc(t.converter, e, n);
    return sh(r, [ Hu(Wu(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, qe.none()) ]);
}

function eh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = ru(t, uu);
    var o = ru(t.firestore, bu), s = Wu(o);
    return sh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = b(e)) || e instanceof Mu ? nc(s, "updateDoc", t._key, e, n, r) : ec(s, "updateDoc", t._key, e)).toMutation(t._key, qe.exists(!0)) ]);
}
 ...
 */ function nh(t) {
    return sh(ru(t.firestore, bu), [ new tn(t._key, qe.none()) ]);
}
 ...
 */ function rh(t, e) {
    var n = ru(t.firestore, bu), r = du(t), i = Kc(t.converter, e);
    return sh(n, [ Hu(Wu(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, qe.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function ih(t) {
    ...
    if (t instanceof uu) f = ru(t.firestore, bu), l = ae(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](ah(f, t, e));
        },
        error: s[c + 1],
    ...
    return function(t, e, i, o) {
        var s = this, a = new Da(o), u = new Os(e, a, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
            ...
            a.Wo(), t.asyncQueue.enqueueAndForget((function() {
                return n(s, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = ks, [ 4 /*yield*/ , Ua(t) ];
 ...
 */ var uh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Qc(t, this._firestore), i = new Hc(this._firestore);
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Qc(t, this._firestore), r = new Gc(this._firestore);
        ...
        var r = Qc(t, this._firestore), i = Kc(r.converter, e, n), o = Hu(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Mu ? nc(this._dataReader, "Transaction.update", s._key, e, n, r) : ec(this._dataReader, "Transaction.update", s._key, e), 
 ...
 * writes.
 */ function yh(t) {
    return Eu(t = ru(t, bu)), new zc(t, (function(e) {
        return sh(t, e);
    }))
    /**
 * Cloud Firestore
...
O = a, u(new h("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new bu(r, t.getProvider("auth-internal"));
    return n = Object.assign({
        useFetchStreams: !0
    }, n), i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), c("@firebase/firestore", "3.0.0-2021720181311", undefined);

export { jc as AbstractUserDataWriter, Vu as Bytes, wu as CACHE_SIZE_UNLIMITED, hu as CollectionReference, uu as DocumentReference, mc as DocumentSnapshot, Mu as FieldPath, qu as FieldValue, bu as Firestore, M as FirestoreError, Uu as GeoPoint, gu as LoadBundleTask, cu as Query, Ec as QueryConstraint, gc as QueryDocumentSnapshot, wc as QuerySnapshot, vc as SnapshotMetadata, Z as Timestamp, uh as Transaction, zc as WriteBatch, Ga as _DatabaseId, It as _DocumentKey, at as _FieldPath, ru as _cast, Q as _debugAssert, ct as _isBase64Available, j as _logWarn, Za as _validateIsNotUsedTogether, rh as addDoc, dh as arrayRemove, lh as arrayUnion, Au as clearIndexedDbPersistence, fu as collection, lu as collectionGroup, au as connectFirestoreEmulator, nh as deleteDoc, hh as deleteField, Ru as disableNetwork, du as doc, Fu as documentId, _u as enableIndexedDbPersistence, Nu as enableMultiTabIndexedDbPersistence, Cu as enableNetwork, Fc as endAt, Mc as endBefore, Eu as ensureFirestoreConfigured, sh as executeWrite, Wc as getDoc, Yc as getDocFromCache, Xc as getDocFromServer, $c as getDocs, Jc as getDocsFromCache, Zc as getDocsFromServer, Tu as getFirestore, ph as increment, Iu as initializeFirestore, Cc as limit, Rc as limitToLast, Ou as loadBundle, Lu as namedQuery, ih as onSnapshot, oh as onSnapshotsInSync, Ac as orderBy, Sc as query, yu as queryEqual, pu as refEqual, ch as runTransaction, fh as serverTimestamp, th as setDoc, q as setLogLevel, Ic as snapshotEqual, Lc as startAfter, Oc as startAt, xu as terminate, eh as updateDoc, ku as waitForPendingWrites, Nc as where, yh as writeBatch };
