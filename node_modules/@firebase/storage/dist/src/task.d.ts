...
export declare class UploadTask {
     ...
     *     callbacks.
     */
    on(type: TaskEvent, nextOrObserver?: StorageObserver<UploadTaskSnapshot> | null | ((snapshot: UploadTaskSnapshot) => unknown), error?: ((a: FirebaseStorageError) => unknown) | null, completed?: Unsubscribe | null): Unsubscribe | Subscribe<UploadTaskSnapshot>;
    /**
