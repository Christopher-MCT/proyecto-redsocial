 ...
 * @internal
 */
export declare function _invalidArgument(message: string): FirebaseStorageError_2;
 ...
 * @internal
 */
export declare function _invalidRootOperation(name: string): FirebaseStorageError_2;
